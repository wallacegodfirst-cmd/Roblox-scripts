...
pcall(function() if type(__gg.MH_restoreIncomingNeedGuard)=="function" then __gg.MH_restoreIncomingNeedGuard() end end)
pcall(function() if type(__gg.MH_disconnectStamWatchers)=="function" then __gg.MH_disconnectStamWatchers() end end)
...
__gg.MH_foodMultAt=0; __gg.MH_foodMultSource=nil; __gg.MH_foodMultSent=0; __gg.MH_foodMultState="waiting for a normal Bite"; __gg.MH_foodMultSafetyCap=4; __gg.MH_foodMultCooldownUntil=0
...
__gg.MH_physicsReplicaId=nil; __gg.MH_physicsSeenAt=0; __gg.MH_stamShiftHeld=false; __gg.MH_stamInputHeld=false; __gg.MH_stamRunRequested=false; __gg.MH_stamDriveSpeed=0; __gg.MH_stamForcedSpeed=16; __gg.MH_stamSyncAt=0; __gg.MH_stamPhysicsSyncAt=0; __gg.MH_stamMaskCount=0; __gg.MH_nativeRunSpeed=0; __gg.MH_stamObservedCurrent=nil; __gg.MH_stamObservedAt=0; __gg.MH_stamGenericProperty=nil; __gg.MH_stamGenericCandidates={}; __gg.MH_stamSavedHumanoid=nil; __gg.MH_stamSavedWalkSpeed=nil; __gg.MH_stamSpeedModel=nil; __gg.MH_stamSpeedHumanoid=nil; __gg.MH_stamLearnedRunSpeed=nil; __gg.MH_stamSpeedAttrs={}; __gg.MH_stamSpeedValues={}; __gg.MH_stamSpeedFixes=0; __gg.MH_incomingNeedWraps={}; __gg.MH_incomingNeedInstalled=false; __gg.MH_incomingNeedState="waiting"; __gg.MH_incomingReplicaId=nil; __gg.MH_incomingReplicaRoot=nil; __gg.MH_incomingStamPin=nil; __gg.MH_eatRecoveryAt=0; __gg.MH_eatRecoveryUntil=0; __gg.MH_eatRecoveryGen=(__gg.MH_eatRecoveryGen or 0)+1; __gg.MH_moveMultiplierPackets={}; __gg.MH_moveMultiplierBaseline={}; __gg.MH_moveIncomingPaths={}; __gg.MH_bloodMax=nil; __gg.MH_bloodReplica=nil; __gg.MH_healthPacket=nil; __gg.MH_guardLastHP=nil
__gg.MH_stamRuntimeAttrs={}; __gg.MH_stamRuntimeValues={}; __gg.MH_stamExhaustRefs={}; __gg.MH_stamWatchConns={}; __gg.MH_stamWatchModel=nil; __gg.MH_stamWatchAt=0; __gg.MH_stamWatchWriting=false; __gg.MH_stamZeroRecoveryUntil=0; __gg.MH_stamZeroTrips=0; __gg.MH_stamLowestCurrent=nil
__gg.MH_stamLearnedWalkSpeed=nil; __gg.MH_autoLockDamageAt=0; __gg.MH_autoLockOwnedTarget=nil
...
__gg.MH_runPacket=nil; __gg.MH_nativeRunActive=false; __gg.MH_runShielded=0; __gg.MH_autoHitClicking=false; __gg.MH_autoHitLocked=nil; __gg.MH_autoHitHighlight=nil; __gg.MH_autoHitSelect=false; __gg.MH_autoHitQuery=nil; __gg.MH_autoHitManualClear=false; __gg.MH_autoHitStatus="No target"; __gg.MH_autoHitTrackBone=nil; __gg.MH_autoHitTrackUntil=0; __gg.MH_autoHitLastHeadPos=nil; __gg.MH_autoHitLastHeadAt=0; __gg.MH_autoHitHeadBone=nil; __gg.MH_autoHitHeadModel=nil; __gg.MH_autoHitHeadAt=0; __gg.MH_autoHitHeadSamplePos=nil; __gg.MH_autoHitHeadSampleAt=0; __gg.MH_autoHitHeadVelocity=Vector3.zero; __gg.MH_autoHitDriveBV=nil; __gg.MH_autoHitDriveBG=nil; __gg.MH_autoHitHeld={}; __gg.MH_autoHitGen=(__gg.MH_autoHitGen or 0)+1; __gg.MH_autoHitNativeReportAt=0; __gg.MH_autoHitNativeReportTarget=nil; __gg.MH_autoHitInputRoute=1; __gg.MH_autoHitClickMethod="waiting"; __gg.MH_autoLockLastHealth=nil; __gg.MH_autoLockStatus="waiting for damage"
__gg.MH_autoHitOutlineSuppressed=false
...
__gg.MH_clearDinoCaches=function(identityKey)
	if type(__gg.MH_disconnectStamWatchers)=="function" then pcall(__gg.MH_disconnectStamWatchers) end
	if type(__gg.MH_stamStopOwnedVelocity)=="function" then pcall(__gg.MH_stamStopOwnedVelocity) end
	if type(__gg.MH_stamRestoreWalkSpeed)=="function" then pcall(__gg.MH_stamRestoreWalkSpeed) end
	...
	__gg.MH_growthState="waiting"; __gg.MH_growthValue=nil; __gg.MH_growthDelta=nil; __gg.MH_growthMass=nil; __gg.MH_growthBase=nil; __gg.MH_stamBoostSpeed=0; __gg.MH_stamPinState="waiting"; __gg.MH_stamReportState="waiting"
	__gg.MH_physicsReplicaId=nil; __gg.MH_physicsSeenAt=0; __gg.MH_stamShiftHeld=false; __gg.MH_stamInputHeld=false; __gg.MH_stamRunRequested=false; __gg.MH_stamDriveSpeed=0; __gg.MH_stamForcedSpeed=16; __gg.MH_stamSyncAt=0; __gg.MH_stamPhysicsSyncAt=0; __gg.MH_stamMaskCount=0; __gg.MH_nativeRunSpeed=0; __gg.MH_stamObservedCurrent=nil; __gg.MH_stamObservedAt=0; __gg.MH_stamGenericProperty=nil; __gg.MH_stamGenericCandidates={}; __gg.MH_stamSavedHumanoid=nil; __gg.MH_stamSavedWalkSpeed=nil; __gg.MH_stamSpeedModel=nil; __gg.MH_stamSpeedHumanoid=nil; __gg.MH_stamLearnedRunSpeed=nil; __gg.MH_stamSpeedAttrs={}; __gg.MH_stamSpeedValues={}; __gg.MH_stamSpeedFixes=0; if identityKey==nil then __gg.MH_incomingReplicaId=nil; __gg.MH_incomingReplicaRoot=nil; __gg.MH_incomingStamPin=nil end; __gg.MH_eatRecoveryAt=0; __gg.MH_eatRecoveryUntil=0; __gg.MH_eatRecoveryGen=(__gg.MH_eatRecoveryGen or 0)+1; __gg.MH_moveMultiplierPackets={}; __gg.MH_moveMultiplierBaseline={}; __gg.MH_moveIncomingPaths={}; __gg.MH_healthPacket=nil; __gg.MH_healthReportAt=nil
	__gg.MH_stamRuntimeAttrs={}; __gg.MH_stamRuntimeValues={}; __gg.MH_stamExhaustRefs={}; __gg.MH_stamWatchConns={}; __gg.MH_stamWatchModel=nil; __gg.MH_stamWatchAt=0; __gg.MH_stamWatchWriting=false; __gg.MH_stamZeroRecoveryUntil=0; __gg.MH_stamLowestCurrent=nil
	__gg.MH_stamLearnedWalkSpeed=nil; __gg.MH_autoLockDamageAt=0; __gg.MH_autoLockOwnedTarget=nil
	pcall(function() if __gg.MH_autoHitHighlight then __gg.MH_autoHitHighlight:Destroy() end end)
	__gg.MH_runPacket=nil; __gg.MH_nativeRunActive=false; __gg.MH_runShielded=0; __gg.MH_autoHitClicking=false; __gg.MH_autoHitLocked=nil; __gg.MH_autoHitHighlight=nil; __gg.MH_autoHitSelect=false; __gg.MH_autoHitQuery=nil; __gg.MH_autoHitManualClear=false; __gg.MH_autoHitStatus="No target"; __gg.MH_autoHitTrackBone=nil; __gg.MH_autoHitTrackUntil=0; __gg.MH_autoHitLastHeadPos=nil; __gg.MH_autoHitLastHeadAt=0; __gg.MH_autoHitHeadBone=nil; __gg.MH_autoHitHeadModel=nil; __gg.MH_autoHitHeadAt=0; __gg.MH_autoHitHeadSamplePos=nil; __gg.MH_autoHitHeadSampleAt=0; __gg.MH_autoHitHeadVelocity=Vector3.zero; __gg.MH_autoHitGen=(__gg.MH_autoHitGen or 0)+1; __gg.MH_autoHitNativeReportAt=0; __gg.MH_autoHitNativeReportTarget=nil; __gg.MH_autoHitInputRoute=1; __gg.MH_autoHitClickMethod="waiting"; __gg.MH_autoLockLastHealth=nil; __gg.MH_autoLockStatus="waiting for damage"
	__gg.MH_autoHitOutlineSuppressed=false
	__gg.MH_releasePacket=nil; __gg.MH_escapeLastBlocked=0; __gg.MH_escapeState=nil; __gg.MH_escapeStatus="waiting"
...
local CFG = {
	...
	InfFood=false, FoodMultiplier=false, FoodMultiplierX=10, InfFoodDiet="Auto", InfWater=false, InfStam=false, InfStamSpeed=16, InfOxygen=false,
	...
	AlwaysDamage=false, AutoHit=false, AutoLockAttacker=false, AutoHitFollow=true, AutoHitFollowDistance=4, AutoHitReverseHead=false, AutoHitRightClick=false, AutoHitColor={r=255,g=35,b=35}, AutoHitTargetName="", AutoHitDistance=45, AutoHitRate=1, DamageRange=120, DamageRate=4, DamagePart="Auto", NoGrabLimit=false,
}
...
loadCfg()
-- INF Food was retired in v8. Keep the legacy config key only so old JSON files still decode, but it can never
-- reactivate its former background controller. Pro Food and the passive Bite multiplier are the supported paths.
CFG.InfFood=false
CFG.AfkEat=false
-- InfStamSpeed is retained only so older config files still decode. v8.17 learns the dinosaur's native sprint speed
-- and uses 16 only as a minimum Humanoid run fallback while W is held; it never drives CFrame or assembly velocity.
CFG.InfStamSpeed=16
CFG.FoodMultiplierX=math.clamp(math.floor(tonumber(CFG.FoodMultiplierX) or 10),1,10000000)
...
CFG.AutoHitReverseHead=false -- legacy toggle retired: keyboard S is selected automatically only after passing the bone
...
for _,key in ipairs({
	...
	"ESPPlayers","FoodESP","FishESP","GemESP","AlertEnabled","CarnMeatTP","ProFood","FullBright","NightVision","NoDarkWater","WaterClear","NoClouds","AlwaysDamage","AutoHit","AutoLockAttacker","AutoHitFollow","AutoHitRightClick","NoGrabLimit","RemoveTrees","Radar",
...
__gg.MH_featureToggleChanged=function(key,value)
	...
	if key=="FoodMultiplier" then
		...
		if not value and type(__gg.MH_cancelFoodMultiplier)=="function" then __gg.MH_cancelFoodMultiplier()
		elseif not value and type(__gg.MH_restoreAfterEating)=="function" then task.defer(__gg.MH_restoreAfterEating); task.delay(0.25,__gg.MH_restoreAfterEating) end
	end
	if key=="InfStam" then
		__gg.MH_stamShiftHeld=false
		__gg.MH_stamZeroRecoveryUntil=0
		local physicalShift=UIS:IsKeyDown(Enum.KeyCode.LeftShift) or UIS:IsKeyDown(Enum.KeyCode.RightShift)
		local nativeDemand=physicalShift or ((__gg.MH_autoHitHeld or {}).LeftShift==true)
		local runDemand=nativeDemand or UIS:IsKeyDown(Enum.KeyCode.W) or ((__gg.MH_autoHitHeld or {}).W==true)
		__gg.MH_stamInputHeld=runDemand; __gg.MH_stamRunRequested=value and runDemand or false
		if __gg.MH_stamBV then pcall(function() __gg.MH_stamBV:Destroy() end); __gg.MH_stamBV=nil end
		task.defer(function()
			if value and type(__gg.MH_installIncomingNeedGuard)=="function" then pcall(__gg.MH_installIncomingNeedGuard) end
			if value and MHNEED then pcall(function() MHNEED.refresh(true); MHNEED.pinStamina(); MHNEED.report("stamina",true); if MHNEED.reportStaminaAll then MHNEED.reportStaminaAll(true) else MHNEED.reportKnownStamina(true) end end) end
			if value and type(__gg.MH_refreshStamSpeedRefs)=="function" then pcall(__gg.MH_refreshStamSpeedRefs,true) end
			if value and type(__gg.MH_refreshStamWatchers)=="function" then pcall(__gg.MH_refreshStamWatchers,true) end
			-- Preserve PE's native sprint lifecycle. While W (or Shift/Auto Hit) is held the guarded state is Run=true; disabling returns
			-- control to the physical key state without leaving a synthetic movement owner behind.
			if type(__gg.MH_syncRun)=="function" then pcall(__gg.MH_syncRun,value and runDemand or nativeDemand) end
			if not value and type(__gg.MH_stamStopOwnedVelocity)=="function" then pcall(__gg.MH_stamStopOwnedVelocity) end
			if not value and type(__gg.MH_stamRestoreWalkSpeed)=="function" then pcall(__gg.MH_stamRestoreWalkSpeed) end
			if not value and type(__gg.MH_disconnectStamWatchers)=="function" then pcall(__gg.MH_disconnectStamWatchers) end
	...
	if key=="AutoHit" then
		...
		if not value then __gg.MH_autoHitGen=(__gg.MH_autoHitGen or 0)+1; __gg.MH_autoHitClicking=false; if type(__gg.MH_autoHitReleaseMovement)=="function" then pcall(__gg.MH_autoHitReleaseMovement) end; if type(__gg.MH_autoHitReleaseClicks)=="function" then pcall(__gg.MH_autoHitReleaseClicks) end end
	end
	if key=="AutoLockAttacker" and not value then __gg.MH_autoLockTarget=nil; __gg.MH_autoLockOwnedTarget=nil; __gg.MH_autoLockLastHealth=nil; __gg.MH_autoLockStatus="off" end
...
__gg.MH_restoreMovementState=function()
	...
	local movementFeatureOn=RUNNING and (CFG.Fly or CFG.Float or CFG.WalkWater or CFG.AntiDrown or CFG.ProFood or CFG.AutoFarmFossil or CFG.AutoFarmGem or CFG.InfStam or (CFG.AutoHit and CFG.AutoHitFollow))
...
__gg.MH_startFoodMultiplier=function(seed)
	...
	-- A fresh genuine Bite owns the interaction. Cancel any older replay before honoring cooldown so no stale remote
	-- worker can keep PE in its reduced movement state after the player has stopped eating.
	if __gg.MH_foodMultBurst then __gg.MH_foodMultGen=(__gg.MH_foodMultGen or 0)+1; __gg.MH_foodMultBurst=false; __gg.MH_foodMultSending=false end
	...
	local now=tick()
	if now<(__gg.MH_foodMultCooldownUntil or 0) then
		__gg.MH_foodMultState="normal Bite accepted; safety cooldown "..string.format("%.1fs",math.max(0,(__gg.MH_foodMultCooldownUntil or 0)-now))
		return true
	end
	__gg.MH_foodMultCooldownUntil=now+2
	local amount=math.clamp(math.floor(tonumber(CFG.FoodMultiplierX) or 1),1,10000000); local requested=amount-1
	-- High textbox values are represented by one short transaction, never by a long remote queue. Four verified
	-- Bite repeats finish quickly, then the generation is closed before locomotion cleanup runs.
	local bonus=math.min(requested,math.clamp(math.floor(tonumber(__gg.MH_foodMultSafetyCap) or 4),1,4))
	...
	__gg.MH_foodMultState="source "..tostring(seed[1]).."; safe pulse +"..tostring(bonus)..(requested>bonus and (" of requested +"..tostring(requested)) or "")
	task.defer(function()
		local sent=0; local cursor=0; local deadline=tick()+0.28
		while sent<bonus do
			if tick()>=deadline or not (RUNNING and CFG.FoodMultiplier and generation==__gg.MH_foodMultGen and seed.identity==__gg.MH_identityKey) then break end
			...
			-- Yield every call so PE can process the transaction without accumulating an interaction backlog.
			task.wait(ok and 0.045 or 0.08)
		end
		__gg.MH_foodMultSending=false
		if generation==__gg.MH_foodMultGen then
			__gg.MH_foodMultGen+=1; __gg.MH_foodMultBurst=false
			__gg.MH_foodMultState=sent>0 and ("last Bite +"..tostring(sent).." sent safely") or "bonus pulse stopped"
		end
		-- Replayed Bite packets do not always emit PE's normal Consuming=false lifecycle. Close it immediately and make
		-- one bounded delayed repair; no replay worker survives into the recovery window.
		task.defer(function() if type(__gg.MH_restoreAfterEating)=="function" then pcall(__gg.MH_restoreAfterEating) end end)
		task.delay(0.4,function() if type(__gg.MH_restoreAfterEating)=="function" then pcall(__gg.MH_restoreAfterEating) end end)
	end)
	return true
end
__gg.MH_cancelFoodMultiplier=function()
	__gg.MH_foodMultGen=(__gg.MH_foodMultGen or 0)+1; __gg.MH_foodMultBurst=false; __gg.MH_foodMultSending=false
	__gg.MH_foodMultState="off; replay queue cleared"
	if type(__gg.MH_restoreAfterEating)=="function" then task.defer(__gg.MH_restoreAfterEating); task.delay(0.25,__gg.MH_restoreAfterEating) end
end
	...
	pcall(function()
		...
		oldNC = hookmeta(game, "__namecall", function(self, ...)
			...
			if m=="FireServer" or m=="InvokeServer" then
				...
				elseif (self.Name=="ReplicaSignal" or self.Name=="ReplicaSignalUnreliable") and not __gg.MH_foodMultSending and not __gg.MH_devFoodSending and (not checkcaller() or select(2,...)=="Bite") then
				local a = table.pack(...)
				...
				-- Some executors/builds do not expose CharacterState.Replica.Id soon enough. A genuine game-originated
				-- SetAction/Run packet is itself a strong owner signal; bind that action replica so stamina capture is not
				-- stuck in the old circular state where an id was required before the first local packet could be learned.
				...
				elseif selfCall and action=="Attack" and self.Name=="ReplicaSignal" then
					...
					local compatible=type(reg)=="table" and reg[1]==id and reg[2]=="RegisterAttack" and tick()-(reg.capturedAt or 0)<=2
				...
				if typeof(id)=="number" then
					if action=="Sip" or action=="Bite" or action=="Eat" or action=="Consume" then
						...
						-- BITE-ONLY CAPTURE: record the ENTIRE Bite call verbatim — the exact
				...
				if typeof(action)=="string" then
						...
						-- Capture PE's exact native Run lifecycle. Infinite Stamina keeps the game's own Run=true state while
						-- W/Shift/Auto Hit requests sprint; it never substitutes velocity or CFrame movement.
						if selfCall and action=="SetAction" and a[3]=="Run" and typeof(a[4])=="boolean" then
							...
							if CFG.InfStam then
								local held=UIS:IsKeyDown(Enum.KeyCode.W) or UIS:IsKeyDown(Enum.KeyCode.LeftShift) or UIS:IsKeyDown(Enum.KeyCode.RightShift) or ((__gg.MH_autoHitHeld or {}).W==true) or ((__gg.MH_autoHitHeld or {}).LeftShift==true)
								__gg.MH_stamRunRequested=held; __gg.MH_runShielded=(__gg.MH_runShielded or 0)+1
								if held and a[4]==false then
									a[4]=true; snap[4]=true; __gg.MH_nativeRunActive=true; __gg.MH_stamReportState="Run=true guard"
									return oldNC(self,table.unpack(a,1,a.n))
								end
								__gg.MH_nativeRunActive=a[4]; __gg.MH_stamReportState=held and "native Run held" or "Run released"
							end
						end
						if selfCall and action=="SetAction" and typeof(a[3])=="string" and a[4]==false then
							local stateName=a[3]:lower()
							if stateName=="consuming" or stateName=="eating" or stateName=="investigating" or stateName=="feeding" or stateName=="foraging" then
						...
						if selfCall and action=="SetProperty" and typeof(a[3])=="string" and typeof(a[4])=="number" then
							...
							-- generic key only after consecutive decreases while Shift movement is requested, then scope it to this
							...
							if nk then
								...
								if ((nk=="food" and CFG.InfFood) or (nk=="stamina" and CFG.InfStam)) and target and target>0 then
									if nk=="stamina" and type(__gg.MH_stamObserveLow)=="function" then __gg.MH_stamObserveLow(a[4],target,"outgoing SetProperty") end
									a[4]=target; snap[4]=target; return oldNC(self,table.unpack(a,1,a.n))
								end
							end
						end
						-- A few PE builds report stamina as a named action rather than SetProperty. Preserve all Run/movement
						-- traffic, but reject an owner-only explicit stamina cost/drain and refill an explicit numeric stamina report.
						if selfCall and CFG.InfStam then
							local needAction=action:lower(); local staminaNamed=needAction:find("stam",1,true) or needAction:find("endurance",1,true) or needAction:find("vigor",1,true) or needAction=="energy"
							local drainNamed=needAction:find("drain",1,true) or needAction:find("deplet",1,true) or needAction:find("reduce",1,true) or needAction:find("cost",1,true) or needAction:find("consume",1,true)
							if staminaNamed and drainNamed then __gg.MH_stamMaskCount=(__gg.MH_stamMaskCount or 0)+1; __gg.MH_stamReportState="blocked exact stamina drain action"; return end
							if staminaNamed and typeof(a[3])=="number" then local target=MHNEED and MHNEED.maxFor and MHNEED.maxFor("stamina"); if target and target>0 then a[3]=target; __gg.MH_stamReportState="refilled named stamina action"; return oldNC(self,table.unpack(a,1,a.n)) end end
						end
...
function MHNEED.replicaId()
	...
	local ok,id=pcall(function() return r and r.Id end)
	if ok and typeof(id)=="number" then return id end
	-- Some PE builds publish CharacterState after the initial ReplicaCreate event. The incoming guard validates that
	-- event's Player reference before keeping this fallback, so source/corpse ids can never become the owner id.
	return typeof(__gg.MH_incomingReplicaId)=="number" and __gg.MH_incomingReplicaId or nil
end
function MHNEED.identity()
	local r=csReplica(); local root=(r and r.Data) or __gg.MH_incomingReplicaRoot; local tags=r and r.Tags
...
function MHNEED.kindFor(name, context)
	...
	-- MaxStats/MaxNeeds are capacity tables, never current-value references. Treating their Stamina entry as current
	-- made the pin look successful while the actual live Stamina.Delta continued draining.
	if c:find("maxstats",1,true) or c:find("maxneeds",1,true) or c:find("maxvitals",1,true) or c:find("capacity",1,true) then return nil end
...
function MHNEED.foodCapacity()
	local r=csReplica(); local root=(r and r.Data) or __gg.MH_incomingReplicaRoot
	...
	pcall(function()
		...
		local tags=(r and r.Tags) or {}; local data=root; local ids={}
...
function MHNEED.refresh(force)
	local r=csReplica(); local root=(r and r.Data) or __gg.MH_incomingReplicaRoot; local character=LP.Character
...
-- `current()` intentionally returns the highest mirror so HUD/reporting stays stable, but stamina exhaustion is
-- triggered by the LOWEST live mirror. A stale full mirror previously hid the controlling value reaching zero.
function MHNEED.lowest(kind,force)
	MHNEED.refresh(force)
	local lowest
	for _,ref in ipairs(MHNEED.refs[kind] or {}) do
		local value
		...
		elseif ref.mode=="attr" and ref.inst and ref.inst.Parent then local ok,v=pcall(function() return ref.inst:GetAttribute(ref.key) end); if ok then value=tonumber(v) end
		elseif ref.mode=="value" and ref.inst and ref.inst.Parent then local ok,v=pcall(function() return ref.inst.Value end); if ok then value=tonumber(v) end end
		if value and value>=0 and (lowest==nil or value<lowest) then lowest=value end
	end
	return lowest
end
function MHNEED.lowestFast(kind)
	local lowest
	for _,ref in ipairs(MHNEED.refs[kind] or {}) do
		local value
		if ref.mode=="table" and ref.tb then value=tonumber(ref.tb[ref.key])
...
-- Write only the current-value references already classified by MHNEED. Capacity/max/rate fields never enter this
-- list, so deliberate local current-value repairs cannot corrupt the dinosaur's maximum need stats.
function MHNEED.setCurrent(kind,target)
	MHNEED.refresh(true); target=math.max(0,tonumber(target) or 0); local changed=0
	for _,ref in ipairs(MHNEED.refs[kind] or {}) do
		if ref.mode=="table" and ref.tb and type(ref.tb[ref.key])=="number" then
			if math.abs(ref.tb[ref.key]-target)>1e-6 then local ok=pcall(function() ref.tb[ref.key]=target end); if ok then changed+=1 end end
		elseif ref.mode=="attr" and ref.inst and ref.inst.Parent then
			local ok,value=pcall(function() return ref.inst:GetAttribute(ref.key) end)
			if ok and type(value)=="number" and math.abs(value-target)>1e-6 and pcall(function() ref.inst:SetAttribute(ref.key,target) end) then changed+=1 end
		elseif ref.mode=="value" and ref.inst and ref.inst.Parent then
			local ok,value=pcall(function() return ref.inst.Value end)
			if ok and type(value)=="number" and math.abs(value-target)>1e-6 and pcall(function() ref.inst.Value=target end) then changed+=1 end
		end
	end
	return changed
end
-- Report a deliberate current need value through the exact owner packet when available. If this PE build has not
-- emitted that packet yet, use at most two concrete property names discovered from the same live food references.
function MHNEED.reportValue(kind,target,force)
	target=math.max(0,tonumber(target) or 0); MHNEED.refresh(); local id=MHNEED.replicaId(); if not id then return false end
	local stamp=tostring(kind)..":manual"; local now=tick(); if not force and now-(__gg.MH_needReportAt[stamp] or 0)<0.22 then return false end
	__gg.MH_needReportAt[stamp]=now
	local packet=__gg.MH_needPackets and __gg.MH_needPackets[kind]
	if type(packet)=="table" and packet.n and packet.n>=4 and packet[1]==id and (not packet.identity or packet.identity==__gg.MH_identityKey) then
		local remote=(packet.instance and packet.instance.Parent and packet.instance) or (RS:FindFirstChild("RemoteEvents") and RS.RemoteEvents:FindFirstChild(packet.remote or "ReplicaSignal"))
		if remote then local args={n=packet.n}; for i=1,packet.n do args[i]=packet[i] end; args[4]=target
			if pcall(function() remote:FireServer(table.unpack(args,1,args.n)) end) then return true end
		end
	end
	local replica=csReplica(); if not (replica and replica.FireServer) then return false end
	local properties={}; local used={}
	local function add(name)
		if type(name)~="string" or name=="" then return end; local normalized=MHNEED.norm(name); local low=name:lower()
		if used[normalized] or low:find("max",1,true) or low:find("rate",1,true) or low:find("drain",1,true) or low:find("capacity",1,true) then return end
	...
	for _,ref in ipairs(MHNEED.refs[kind] or {}) do
		...
		if generic and kind=="food" and (path:find("food",1,true) or path:find("hunger",1,true)) then add(path:find("hunger",1,true) and "Hunger" or "Food")
		elseif MHNEED.kindFor(key,ref.path)==kind then add(key) end
		if #properties>=2 then break end
	end
	if #properties==0 and kind=="food" then add("Food") end
	local sent=0; for index,property in ipairs(properties) do if index>2 then break end; if pcall(function() replica:FireServer("SetProperty",property,target) end) then sent+=1 end end
	return sent>0
end
function MHNEED.maxForProperty(kind,property)
	...
	-- A stamina high-water value is local-only. Remote rewrites require a paired/HUD maximum from this dinosaur.
...
-- Stamina appears in several live layouts that the generic ref list can briefly miss while a dinosaur streams:
-- Stats.Stamina, PlayerData.Stamina, or Stamina.Delta/Max. Pin those concrete numeric fields too, but never a
-- Max/Cost/Drain/Rate setting. This is local bar/state protection; the exact SetProperty report below handles the
-- same verified character replica and the native Run guard prevents exhaustion from cancelling an active sprint.
function MHNEED.pinStamina()
	local mx,changed=MHNEED.pin("stamina")
	local incoming=__gg.MH_incomingStamPin
	local incomingMax=incoming and (tonumber(incoming.max) or tonumber(__gg.MH_needHighWater.stamina))
	if incomingMax and incomingMax>0 and (not mx or incomingMax>mx) then mx=incomingMax; MHNEED.max.stamina=mx; MHNEED.maxSource.stamina=incoming.max and "paired" or "highwater" end
	if incoming and incoming.tb and incoming.key~=nil and mx and mx>0 and type(incoming.tb[incoming.key])=="number" and incoming.tb[incoming.key]<mx then
		local ok=pcall(function() incoming.tb[incoming.key]=mx end); if ok then changed=true end
	end
	if not (mx and mx>0) then return mx,changed end
	local seen={}
	local function sweep(tb,path,depth)
		if type(tb)~="table" or seen[tb] or depth>5 then return end; seen[tb]=true
		for key,value in pairs(tb) do
			local childPath=path.."."..tostring(key)
			if type(value)=="number" and MHNEED.kindFor(key,path)=="stamina" and value<mx then
				local ok=pcall(function() tb[key]=mx end); if ok then changed=true end
			elseif type(value)=="table" then sweep(value,childPath,depth+1) end
		end
	end
	local rep=csReplica(); pcall(function() sweep((rep and rep.Data) or __gg.MH_incomingReplicaRoot,"Replica.Data",0); sweep(CharacterState,"CharacterState",0) end)
	__gg.MH_stamAuthoritativeMax=mx
	return mx,changed
end
-- Per-frame fast path: writes only already-resolved current-value references plus the verified ReplicaCreate pin.
-- The slower deep discovery remains on its bounded worker; this path is cheap enough to run before every physics step.
function MHNEED.pinStaminaFast()
	local incoming=__gg.MH_incomingStamPin
	local mx=tonumber(MHNEED.max and MHNEED.max.stamina) or (incoming and tonumber(incoming.max)) or tonumber(__gg.MH_needHighWater and __gg.MH_needHighWater.stamina)
	if not (mx and mx>0) then return nil,false end
	local changed=false
	for _,ref in ipairs(MHNEED.refs.stamina or {}) do
		local target=tonumber(ref.max) or mx
		if target and target>0 then
			if ref.mode=="table" and ref.tb and type(ref.tb[ref.key])=="number" and ref.tb[ref.key]<target then ref.tb[ref.key]=target; changed=true
			elseif ref.mode=="attr" and ref.inst and ref.inst.Parent then local ok,value=pcall(function() return ref.inst:GetAttribute(ref.key) end); if ok and type(value)=="number" and value<target then pcall(function() ref.inst:SetAttribute(ref.key,target) end); changed=true end
			elseif ref.mode=="value" and ref.inst and ref.inst.Parent then local ok,value=pcall(function() return ref.inst.Value end); if ok and type(value)=="number" and value<target then pcall(function() ref.inst.Value=target end); changed=true end end
		end
	end
	if incoming and incoming.tb and incoming.key~=nil and type(incoming.tb[incoming.key])=="number" and incoming.tb[incoming.key]<mx then incoming.tb[incoming.key]=mx; changed=true end
	__gg.MH_stamAuthoritativeMax=mx
	return mx,changed
end
...
-- Strong fallback retained from the build that successfully held the meter. It reports only this verified
-- dinosaur's concrete stamina aliases plus the canonical Stamina parent, at a bounded rate and without touching
-- WalkSpeed, CFrame, velocity, or keyboard movement.
function MHNEED.reportStaminaAll(force)
	MHNEED.refresh(); local mx=MHNEED.max.stamina; local source=MHNEED.maxSource and MHNEED.maxSource.stamina
	if not (mx and mx>0 and (source=="paired" or source=="hud" or source=="highwater")) then return false end
	local rep=csReplica(); local id=MHNEED.replicaId(); if not (rep and id and rep.FireServer) then return false end
	local stamp="stamina:all"; local now=tick(); if not force and now-(__gg.MH_needReportAt[stamp] or 0)<0.18 then return false end; __gg.MH_needReportAt[stamp]=now
	local properties={}; local used={}
	local function add(name)
		if type(name)~="string" or name=="" then return end; local low=name:lower(); local normalized=MHNEED.norm(name)
		if low:find("max",1,true) or low:find("rate",1,true) or low:find("drain",1,true) or low:find("cost",1,true) or used[normalized] then return end
	...
	for _,ref in ipairs(MHNEED.refs.stamina or {}) do
		local key=ref.key or (ref.inst and ref.inst.Name); local normalized=MHNEED.norm(key); local path=tostring(ref.path or ""):lower()
		local generic=normalized=="current" or normalized=="cur" or normalized=="value" or normalized=="amount" or normalized=="level" or normalized=="delta"
		if generic then if path:find("stam",1,true) then add("Stamina") elseif path:find("energy",1,true) then add("Energy") elseif path:find("endur",1,true) then add("Endurance") end
		elseif MHNEED.kindFor(key,ref.path)=="stamina" then add(key) end
	end
	add("Stamina")
	local sent=0; for index,property in ipairs(properties) do if index>4 then break end; if pcall(function() rep:FireServer("SetProperty",property,mx) end) then sent+=1 end end
	__gg.MH_stamReportState=sent>0 and ("bounded hard-pin "..tostring(sent).." path(s) / "..tostring(source)) or "stamina report failed"
	return sent>0
end
-- Incoming need guard (adapted from the supplied ALWAYS RUN reference). PE applies ReplicaSet values to its local
-- movement controller before ordinary table pins can repair them; at zero stamina that single frame is enough to
-- enter the exhausted speed state. This wrapper changes only this dinosaur's verified Stamina/Food value before the
-- game's existing listeners receive it, then forwards every other event unchanged. No HUD text is replaced with ∞.
__gg.MH_restoreIncomingNeedGuard=function()
	for _,wrap in ipairs(__gg.MH_incomingNeedWraps or {}) do
		pcall(function() if wrap.connection then wrap.connection:Disconnect() end end)
		for _,original in ipairs(wrap.originals or {}) do pcall(function() original:Enable() end) end
	end
	__gg.MH_incomingNeedWraps={}; __gg.MH_incomingNeedInstalled=false; __gg.MH_incomingNeedState="restored"
end
local function MH_incomingHeldRun()
	local held=false; pcall(function() held=UIS:IsKeyDown(Enum.KeyCode.W) or UIS:IsKeyDown(Enum.KeyCode.LeftShift) or UIS:IsKeyDown(Enum.KeyCode.RightShift) end)
	return held or ((__gg.MH_autoHitHeld or {}).W==true) or ((__gg.MH_autoHitHeld or {}).LeftShift==true)
end
local function MH_incomingPathKind(path)
	if type(path)~="table" then return nil end
	local labels={}; for i=1,#path do labels[#labels+1]=tostring(path[i]) end
	local context=table.concat(labels,"."):lower()
	if context:find("max",1,true) or context:find("capacity",1,true) or context:find("drain",1,true) or context:find("rate",1,true) or context:find("regen",1,true) or context:find("cost",1,true) then return nil end
	local leaf=path[#path]; local kind=MHNEED.kindFor(leaf,context)
	if kind then return kind end
	for _,label in ipairs(labels) do kind=MHNEED.kindFor(label,context); if kind then return kind end end
	return nil
end
local function MH_applyIncomingPath(path,value)
	if type(path)~="table" or #path<1 then return end
	local rep=csReplica(); local roots={(rep and rep.Data) or __gg.MH_incomingReplicaRoot,CharacterState and CharacterState.PlayerData,CharacterState}
	for _,root in ipairs(roots) do if type(root)=="table" then
		local cursor=root; local first=1
		if path[1]=="Data" and cursor.Data==nil then first=2 end
		for index=first,#path-1 do if type(cursor)~="table" then cursor=nil; break end; cursor=cursor[path[index]] end
		if type(cursor)=="table" and path[#path]~=nil and cursor[path[#path]]~=nil then pcall(function() cursor[path[#path]]=value end) end
	end end
end
-- ReplicaCreate is the earliest authoritative owner map in PE. CharacterState.Replica can be published after that
-- packet (or hide Id on some executor builds), so learn only the Character entry whose refs identify LocalPlayer.
-- This closes the old circular failure where the incoming stamina guard required an id before it could discover it.
__gg.MH_incomingOwnedReplica=function(info)
	if type(info)~="table" then return false end
	local refs=info[2]; if type(refs)~="table" then return nil end
	local explicit=false
	for key,value in pairs(refs) do
		local name=tostring(key):lower()
		if name:find("player",1,true) or name:find("owner",1,true) or name:find("user",1,true) then
			explicit=true
			if value==LP or (typeof(value)=="Instance" and value:IsA("Player") and value==LP)
				or (type(value)=="number" and value==LP.UserId)
				or (type(value)=="string" and (value:lower()==LP.Name:lower() or value:lower()==tostring(LP.DisplayName or ""):lower())) then return true end
		end
	end
	return explicit and false or nil
end
__gg.MH_scanIncomingStamina=function(root)
	if type(root)~="table" then return nil end
	local best; local seen={}
	local function walk(tb,path,depth,maxTb)
		if type(tb)~="table" or seen[tb] or depth>7 then return end; seen[tb]=true
		for key,value in pairs(tb) do
			local child=path.."."..tostring(key)
			if type(value)=="number" and MHNEED.kindFor(key,path)=="stamina" then
				local maximum=MHNEED.pairedMax(tb,key,maxTb,"stamina",value)
				local score=(maximum and 1000 or 0)+math.max(0,tonumber(value) or 0)
				if not best or score>best.score then best={tb=tb,key=key,max=maximum,path=child,score=score} end
			elseif type(value)=="table" then
				local nextMax=type(maxTb)=="table" and maxTb[key] or nil
				if type(nextMax)~="table" then nextMax=value.MaxStats or value.Max or (tostring(key):lower()=="stats" and tb.MaxStats) or maxTb end
				walk(value,child,depth+1,nextMax)
			end
		end
	end
	walk(root,"ReplicaCreate",0,root.MaxStats or root.Max)
	return best
end
__gg.MH_adoptIncomingCharacter=function(id,info)
	local root=type(info)=="table" and info[3]
	if typeof(id)~="number" or type(root)~="table" then return false end
	__gg.MH_incomingReplicaId=id; __gg.MH_incomingReplicaRoot=root; __gg.MH_verifiedReplicaId=id; noteReplicaId(id)
	local pin=__gg.MH_scanIncomingStamina(root); __gg.MH_incomingStamPin=pin
	if pin then
		local current=tonumber(pin.tb and pin.tb[pin.key]); local maximum=tonumber(pin.max)
		if current and current>0 then __gg.MH_needHighWater.stamina=math.max(tonumber(__gg.MH_needHighWater.stamina) or 0,current) end
		if maximum and maximum>0 then __gg.MH_needHighWater.stamina=math.max(tonumber(__gg.MH_needHighWater.stamina) or 0,maximum) end
		local target=maximum or __gg.MH_needHighWater.stamina
		if CFG.InfStam and target and pin.tb and type(pin.tb[pin.key])=="number" then pin.tb[pin.key]=target end
	end
	MHNEED.root=nil; MHNEED.at=0; __gg.MH_incomingNeedState="owner ReplicaCreate "..tostring(id)..(pin and (" | "..tostring(pin.path)) or " | stamina pending")
	return true
end
__gg.MH_motionPathKind=function(text)
	local n=tostring(text or ""):lower():gsub("[^%w]","")
	if n:find("movementmultiplier",1,true) or n:find("speedmultiplier",1,true) or n:find("walkspeedmultiplier",1,true)
		or n:find("runspeedmultiplier",1,true) or n:find("locomotionmultiplier",1,true) or n:find("movementmodifier",1,true) or n:find("speedmodifier",1,true) then return "multiplier" end
	if n:find("walkspeed",1,true) or n:find("movespeed",1,true) or n:find("runspeed",1,true) or n:find("sprintspeed",1,true) or n=="speed" then return "speed" end
	return nil
end
-- A low value is recorded BEFORE it is replaced so the locomotion guard can repair the exhaustion transition in
-- the same frame. This does not guess stamina: callers pass only fields already classified as this dino's stamina.
__gg.MH_stamObserveLow=function(value,maximum,source)
	value=tonumber(value); maximum=tonumber(maximum)
	if not (RUNNING and CFG.InfStam and value and maximum and maximum>0 and value<=math.max(0.5,maximum*0.15)) then return false end
	__gg.MH_stamLowestCurrent=value; __gg.MH_stamZeroRecoveryUntil=math.max(tonumber(__gg.MH_stamZeroRecoveryUntil) or 0,tick()+2.5)
	if tick()-(__gg.MH_stamZeroTripAt or 0)>0.08 then
		__gg.MH_stamZeroTripAt=tick(); __gg.MH_stamZeroTrips=(__gg.MH_stamZeroTrips or 0)+1
		__gg.MH_stamReportState="zero transition blocked: "..tostring(source or "stamina")
		task.defer(function()
			if not (RUNNING and CFG.InfStam) then return end
			pcall(function() if MHNEED.pinStaminaFast then MHNEED.pinStaminaFast() else MHNEED.pinStamina() end end)
			pcall(function() if type(__gg.MH_stamRepairMotionNow)=="function" then __gg.MH_stamRepairMotionNow(true) end end)
			pcall(function() if MH_incomingHeldRun() and type(__gg.MH_syncRun)=="function" then __gg.MH_syncRun(true) end end)
		end)
	end
	return true
end
local function MH_rewriteIncomingNeed(ap)
	local n=ap.n or #ap
	-- ReplicaCreate shape: ({[replicaId]={token,refs,data,version}, ...}). Prefer an explicit LocalPlayer ref;
	-- only accept an owner-less Character when it is the sole Character candidate in this packet.
	if type(ap[1])=="table" then
		local unknown={}; local adopted=false
		for replicaId,info in pairs(ap[1]) do if typeof(replicaId)=="number" and type(info)=="table" and info[1]=="Character" and type(info[3])=="table" then
			local owned=__gg.MH_incomingOwnedReplica(info)
			if owned==true then adopted=__gg.MH_adoptIncomingCharacter(replicaId,info); break elseif owned==nil then unknown[#unknown+1]={replicaId,info} end
		end end
		if not adopted and #unknown==1 then __gg.MH_adoptIncomingCharacter(unknown[1][1],unknown[1][2]) end
		return
	end
	local id=MHNEED.replicaId(); if not id then return end
	-- Exhaustion and eating locks can arrive as booleans rather than a numeric stamina value. Correct those before
	-- PE's locomotion listener sees them; only the verified local Character replica is touched.
	if n>=3 and ap[1]==id and type(ap[2])=="table" then
		local labels={}; for index=1,#ap[2] do labels[index]=tostring(ap[2][index]):lower() end; local text=table.concat(labels,".")
		local normalized=text:gsub("[^%w]",""); local value=ap[n]
		if CFG.InfStam and type(value)=="boolean" then
			if value==true and (normalized:find("exhaust",1,true) or normalized:find("fatigu",1,true) or normalized:find("tired",1,true)) then ap[n]=false; MH_applyIncomingPath(ap[2],false)
			elseif value==false and (normalized:find("canrun",1,true) or normalized:find("cansprint",1,true)) then ap[n]=true; MH_applyIncomingPath(ap[2],true)
			elseif value==false and MH_incomingHeldRun() and (normalized:find("running",1,true) or normalized:find("sprinting",1,true)) then ap[n]=true; MH_applyIncomingPath(ap[2],true) end
		end
	end
	-- Some builds echo action/property packets in the same shape used by FireServer.
	if n>=4 and ap[1]==id and ap[2]=="SetAction" and ap[3]=="Run" and type(ap[4])=="boolean" then
		if CFG.InfStam and MH_incomingHeldRun() and ap[4]==false then ap[4]=true; __gg.MH_nativeRunActive=true; __gg.MH_stamReportState="incoming Run=false corrected"; task.defer(function() if RUNNING and CFG.InfStam then pcall(__gg.MH_syncRun,true) end end) end
		return
	end
	if n>=4 and ap[1]==id and ap[2]=="SetProperty" and type(ap[3])=="string" and type(ap[4])=="number" then
		local kind=MHNEED.kindFor(ap[3],"")
		if kind=="stamina" then
			if ap[4]>0 then __gg.MH_needHighWater.stamina=math.max(tonumber(__gg.MH_needHighWater.stamina) or 0,ap[4]) end
			if CFG.InfStam then local target=MHNEED.maxForProperty("stamina",ap[3]) or MHNEED.maxFor("stamina") or __gg.MH_needHighWater.stamina; if target and target>0 then __gg.MH_stamObserveLow(ap[4],target,"incoming property"); ap[4]=target; __gg.MH_stamObservedCurrent=target; __gg.MH_stamReportState="incoming stamina property pinned" end end
		end
		return
	end
	-- ReplicaSet: (verifiedCharacterId, {relative data path...}, value).
	if n>=3 and ap[1]==id and type(ap[2])=="table" and type(ap[n])=="number" then
		local path=ap[2]; local kind=MH_incomingPathKind(path); local value=ap[n]; local labels={}
		for index=1,#path do labels[index]=tostring(path[index]):lower() end
		local pathText=table.concat(labels,"."); local leaf=labels[#labels] or ""
		local motion=__gg.MH_motionPathKind(pathText)
		if motion then
			local rows=__gg.MH_moveIncomingPaths or {}; __gg.MH_moveIncomingPaths=rows; local row=rows[pathText] or {path={}}
			for index=1,#path do row.path[index]=path[index] end
			if motion=="multiplier" and value>=0.95 and value<=4 then row.baseline=math.max(tonumber(row.baseline) or 0,value)
			elseif motion=="speed" and value>0 and value<500 then row.baseline=math.max(tonumber(row.baseline) or 0,value) end
			local baseline=tonumber(row.baseline) or (motion=="multiplier" and 1 or tonumber(__gg.MH_stamLearnedRunSpeed) or 16); rows[pathText]=row
			if (CFG.InfStam or tick()<(__gg.MH_eatRecoveryUntil or 0)) and value<baseline*0.8 then ap[n]=baseline; value=baseline; MH_applyIncomingPath(path,baseline); __gg.MH_stamSpeedFixes=(__gg.MH_stamSpeedFixes or 0)+1 end
		end
		if pathText:find("stam",1,true) and (leaf:find("max",1,true) or leaf:find("capacity",1,true) or leaf:find("limit",1,true)) and value>0 then
			__gg.MH_needHighWater.stamina=math.max(tonumber(__gg.MH_needHighWater.stamina) or 0,value)
			if __gg.MH_incomingStamPin then __gg.MH_incomingStamPin.max=value end
		end
		if kind=="stamina" and CFG.InfStam then
			if value>0 then __gg.MH_needHighWater.stamina=math.max(tonumber(__gg.MH_needHighWater.stamina) or 0,value) end
			local pin=__gg.MH_incomingStamPin; local target=(pin and tonumber(pin.max)) or MHNEED.maxFor("stamina") or __gg.MH_needHighWater.stamina
			if target and target>0 then __gg.MH_stamObserveLow(value,target,"incoming ReplicaSet"); ap[n]=target; value=target; __gg.MH_stamObservedCurrent=target; __gg.MH_stamObservedAt=tick(); __gg.MH_stamReportState="incoming ReplicaSet pinned before exhaustion" end
		end
		if kind then MH_applyIncomingPath(path,value) end
	end
end
__gg.MH_installIncomingNeedGuard=function()
	if __gg.MH_incomingNeedInstalled then return true end
	if typeof(getconnections)~="function" then __gg.MH_incomingNeedState="getconnections unavailable; table/report guard active"; return false end
	local folder=RS:FindFirstChild("RemoteEvents"); if not folder then __gg.MH_incomingNeedState="RemoteEvents unavailable"; return false end
	local installed=0; __gg.MH_incomingNeedWraps={}; local remotes={}
	-- ReplicaCreate may use a different Replica-named event than client FireServer traffic, and the unreliable signal
	-- is an UnreliableRemoteEvent rather than a RemoteEvent. Guard every bounded Replica event in this one folder.
	for _,remote in ipairs(folder:GetChildren()) do if (remote:IsA("RemoteEvent") or remote:IsA("UnreliableRemoteEvent")) and remote.Name:lower():find("replica",1,true) then remotes[#remotes+1]=remote end end
	for _,remote in ipairs(remotes) do
		if remote and remote.Parent then
			local ok,connections=pcall(getconnections,remote.OnClientEvent); local functions,originals={},{ }
			if ok and type(connections)=="table" then for _,connection in ipairs(connections) do
				local callback; pcall(function() callback=connection.Function end)
				if type(callback)=="function" and pcall(function() connection:Disable() end) then functions[#functions+1]=callback; originals[#originals+1]=connection end
			end end
			if #functions>0 then
				local wrapper=remote.OnClientEvent:Connect(function(...)
					local args=table.pack(...); pcall(MH_rewriteIncomingNeed,args)
					for _,callback in ipairs(functions) do task.spawn(callback,table.unpack(args,1,args.n)) end
				end)
				__gg.MH_incomingNeedWraps[#__gg.MH_incomingNeedWraps+1]={connection=wrapper,originals=originals}; installed+=1
			end
		end
	end
	__gg.MH_incomingNeedInstalled=installed>0; __gg.MH_incomingNeedState=installed>0 and ("guarding "..tostring(installed).." replica event(s)") or "no replaceable listeners; table/report guard active"
	-- The initial ReplicaCreate usually happened before the hub loaded. Adopt the already-live CharacterState replica,
	-- or match that exact Data table back to Replica.Client's registry when its public Id field is hidden.
	pcall(function()
		local current=csReplica(); local currentData=current and current.Data; local currentId=current and tonumber(current.Id)
		if currentData and currentId then __gg.MH_adoptIncomingCharacter(currentId,{"Character",{Player=LP},currentData})
		elseif currentData and type(__gg.MH_getReplicaRegistry)=="function" then
			local registry=__gg.MH_getReplicaRegistry()
			if type(registry)=="table" then for key,replica in pairs(registry) do if type(replica)=="table" and replica.Data==currentData then
				local resolved=tonumber(replica.Id) or (typeof(key)=="number" and key); if resolved then __gg.MH_adoptIncomingCharacter(resolved,{"Character",{Player=LP},currentData}); break end
			end end end
		end
	end)
	return installed>0
...
__gg.MH_restoreMoveMultipliers=function()
	...
	for _,row in pairs(__gg.MH_moveIncomingPaths or {}) do
		local baseline=tonumber(row.baseline); if baseline and type(row.path)=="table" then pcall(MH_applyIncomingPath,row.path,baseline); restored=true end
	end
	return restored
end
...
__gg.MH_restoreAfterEating=function()
	...
	__gg.MH_eatRecoveryGen=(__gg.MH_eatRecoveryGen or 0)+1; local recoveryGen=__gg.MH_eatRecoveryGen
	-- Four seconds covers PE's delayed post-Bite movement-state update without leaving a permanent speed owner.
	__gg.MH_eatRecoveryUntil=now+4
	...
	local function repairOnce()
		...
		for key,value in pairs(tb) do
			...
			if type(value)=="boolean" and value==true and (n=="consuming" or n=="eating" or n=="investigating" or n=="feeding" or n=="foraging" or n=="interactionlocked" or n=="movementlocked") then pcall(function() tb[key]=false end)
			elseif type(value)=="number" and __gg.MH_motionPathKind(n) then
				local kind=__gg.MH_motionPathKind(n); local target=kind=="multiplier" and 1 or tonumber(__gg.MH_stamLearnedWalkSpeed) or tonumber(__gg.MH_stamLearnedRunSpeed) or 16
				if value<target*0.8 then pcall(function() tb[key]=target end) end
			elseif type(value)=="table" then sweep(value,depth+1) end
		end
		end
		pcall(function() local rep=csReplica(); sweep((rep and rep.Data) or __gg.MH_incomingReplicaRoot,0); sweep(CharacterState,0) end)
		pcall(__gg.MH_restoreMoveMultipliers)
		pcall(function()
			if type(__gg.MH_refreshStamSpeedRefs)=="function" then __gg.MH_refreshStamSpeedRefs(true) end
			for _,row in ipairs(__gg.MH_stamSpeedAttrs or {}) do if row.inst and row.inst.Parent then local value=row.inst:GetAttribute(row.key); local target=tonumber(row.walk) or tonumber(row.run); if type(value)=="number" and target and value<target*0.8 then row.inst:SetAttribute(row.key,target) end end end
			for _,row in ipairs(__gg.MH_stamSpeedValues or {}) do if row.inst and row.inst.Parent then local value=tonumber(row.inst.Value); local target=tonumber(row.walk) or tonumber(row.run); if value and target and value<target*0.8 then row.inst.Value=target end end end
		end)
	end
	repairOnce()
	local physicalShift=UIS:IsKeyDown(Enum.KeyCode.LeftShift) or UIS:IsKeyDown(Enum.KeyCode.RightShift)
	local nativeDemand=physicalShift or ((__gg.MH_autoHitHeld or {}).LeftShift==true)
	local runHeld=nativeDemand or (CFG.InfStam and (UIS:IsKeyDown(Enum.KeyCode.W) or ((__gg.MH_autoHitHeld or {}).W==true)))
	__gg.MH_stamInputHeld=runHeld; __gg.MH_stamRunRequested=CFG.InfStam and runHeld or false
	pcall(__gg.MH_syncRun,runHeld)
	...
	task.spawn(function()
		for _=1,19 do
			task.wait(0.2); if not RUNNING or not alive() or recoveryGen~=__gg.MH_eatRecoveryGen then break end
			local heldE=false; pcall(function() heldE=UIS:IsKeyDown(Enum.KeyCode.E) end); if heldE then break end
			repairOnce()
		end
		local nativeDemand=UIS:IsKeyDown(Enum.KeyCode.LeftShift) or UIS:IsKeyDown(Enum.KeyCode.RightShift) or ((__gg.MH_autoHitHeld or {}).LeftShift==true)
		local runHeld=nativeDemand or (CFG.InfStam and (UIS:IsKeyDown(Enum.KeyCode.W) or ((__gg.MH_autoHitHeld or {}).W==true)))
		pcall(__gg.MH_syncRun,runHeld)
	end)
	return true
...
__gg.MH_foodCarnWords={"corpse","carcass","carrion","deadbody","leftcharacter","dinosaurspawn","spawnedmeat","meat","flesh","chunk","bone","chitin","organ","fish","spawnedai","lepisosteus","onchopristis","acipenser","concavotectum","bawitius","mawsonia","gar","sturgeon","coelacanth","sawfish","bichir","shellfish","egg","insect","grub","larva"}
__gg.MH_foodHerbWords={"plant","flora","vegetation","fern","fibrous","woody","arborescent","horsetail","algae","root","fruit","berry","seed","nut","mushroom","nectar","leaf","leaves","frond","grass","moss","bush","shrub","flower","cycad","conifer","ginkgo","redwood","equisetum"}
...
-- Build a diet-specific source list directly from every live Replica, including sources whose world model is not
-- streamed to this client. This is what lets a carnivore try corpses/fish another player can see and eat far away.
function __gg.MH_foodReplicaDietScore(rep,diet)
	if type(rep)~="table" then return -100 end
	local general=__gg.MH_foodReplicaScore(rep); if general<=-100 then return -100 end
	local wanted=(diet=="Herbivore") and (__gg.MH_foodHerbWords or {}) or (__gg.MH_foodCarnWords or {})
	local opposite=(diet=="Herbivore") and (__gg.MH_foodCarnWords or {}) or (__gg.MH_foodHerbWords or {})
	local score,count=0,0; local seen={}
	local function addText(value,weight)
		local s=tostring(value or ""):lower(); if s=="" then return end
		for _,word in ipairs(wanted) do if s:find(word,1,true) then score+=weight; break end end
		for _,word in ipairs(opposite) do if s:find(word,1,true) then score-=math.max(1,math.floor(weight*0.65)); break end end
	end
	local function walk(value,depth,keyName)
		if count>300 or depth>4 then return end; count+=1
		local ty=typeof(value)
		if ty=="Instance" then
			addText(value.Name,7); local ok,path=pcall(function() return value:GetFullName() end); if ok then addText(path,10) end
			if diet=="Carnivore" then pcall(function()
				if value:FindFirstAncestor("SpawnedMeat") or value:FindFirstAncestor("CorpseSpawns") or value:FindFirstAncestor("LeftCharacters") or value:FindFirstAncestor("Bonepiles") then score+=90 end
				local ai=value:FindFirstAncestor("SpawnedAI"); if ai and (value:FindFirstAncestor("Fish") or isFishName(value.Name)) then score+=95 end
			end) elseif value:IsA("BasePart") then local c=value.Color; if c.G>0.22 and c.G>c.R*1.12 and c.G>c.B*1.08 then score+=25 end end
		elseif type(value)=="string" then addText(value,6)
		elseif type(value)=="table" and not seen[value] then
			seen[value]=true; for k,v in pairs(value) do addText(k,2); walk(v,depth+1,k); if count>300 then break end end
		elseif keyName then addText(keyName,1) end
	end
	addText(rep.Token,12); walk(rep.Tags,0,"Tags"); walk(rep.Data,0,"Data")
	if general>0 then score+=math.min(general,8) end
	return score
end
function __gg.MH_refreshDietFoodReplicas(diet,force)
	diet=(diet=="Herbivore") and "Herbivore" or "Carnivore"
	local old=__gg.MH_foodDietReplicaState or {diet=diet,list={},at=0,cursor=0}; local now=tick()
	if not force and old.diet==diet and now-(old.at or 0)<1.1 then return old end
	local registry=__gg.MH_getReplicaRegistry(); local list={}; local selfId=MHNEED and MHNEED.replicaId and MHNEED.replicaId(); local scanned=0
	if type(registry)=="table" then for id,rep in pairs(registry) do
		scanned+=1; if scanned>6000 then break end
		id=tonumber((type(rep)=="table" and rep.Id) or id)
		if id and id~=selfId and type(rep)=="table" and type(rep.FireServer)=="function" then
			local score=__gg.MH_foodReplicaDietScore(rep,diet); if score>0 then list[#list+1]={id=id,rep=rep,score=score} end
		end
	end end
	table.sort(list,function(a,b) if a.score==b.score then return a.id<b.id end return a.score>b.score end)
	while #list>512 do table.remove(list) end
	local state={diet=diet,list=list,at=now,cursor=(old.diet==diet and old.cursor) or 0}; __gg.MH_foodDietReplicaState=state; __gg.MH_foodDietReplicaCount=#list
	return state
end
function __gg.MH_fireDietFoodReplicas(rs,buf,diet,budget)
	local state=__gg.MH_refreshDietFoodReplicas(diet,false); local list=state.list or {}; if #list==0 then return 0 end
	budget=math.clamp(math.floor(tonumber(budget) or 10),2,18); local sent=0
	for _=1,math.min(budget,#list) do
		state.cursor=((state.cursor or 0)%#list)+1; local entry=list[state.cursor]
...
local function fireAttack(targetModel, skipSound, clickedPart, sequence)
	...
	if clickedPart and (clickedPart:IsA("BasePart") or clickedPart:IsA("Bone") or clickedPart:IsA("Attachment")) and clickedPart:IsDescendantOf(targetModel) then
		local p=_bonePos(clickedPart)
	...
	if not CFG.AutoHit and (CFG.HitboxExpand or CFG.AlwaysDamage or CFG.SilentAim) then
...
if FWindow then
	...
	local ICONS = {Combat="swords", PvP="target", Movement="footprints", Survival="heart-pulse", Growth="sprout", ["Auto Farm"]="bot", Target="crosshair", Teleport="map-pin", Sandbox="box", Visuals="eye", Skins="palette", Misc="wrench", Settings="settings", Info="info", Admin="shield", Rules="list"}
...
-- PREMIUM: no Growth tab. That tab is the food-growth suite (Pro Food + multiplier helpers), which premium buyers are
...
mkTab("Auto Farm",6); mkTab("Teleport",7); mkTab("Sandbox",7.25)
...
do local p=Pages["Combat"]
	...
	mkToggle(a,"Extra M2 / right-click","AutoHitRightClick",5)
	mkColorPicker(a,"Target outline colour","AutoHitColor",6,function() if __gg.MH_autoHitApplyColor then __gg.MH_autoHitApplyColor() end end)
	mkTextbox(a,"Auto Hit username","AutoHitTargetName",7,false)
	mkBtn(a,"Click a dinosaur to lock",function() __gg.MH_autoHitSelect=true; __gg.MH_autoHitStatus="Click a dinosaur"; pcall(function() notify("Auto Hit","Click the dinosaur you want to lock.") end) end,8)
	mkBtn(a,"Clear Auto Hit target",function() if __gg.MH_autoHitClear then __gg.MH_autoHitClear(true) else CFG.AutoHitTargetName=""; saveCfg() end end,9)
	mkSlider(a,"Auto Hit lock distance","AutoHitDistance",5,400,10,5)
	mkSlider(a,"Auto Hit clicks / sec","AutoHitRate",1,6,11,1)
	__gg.MH_autoHitStatusLabel=mkStatus(a,"Auto Hit target",12)
	mkDropdown(a,"Aim Part", function() return {"Hitbox","Head","Spine","Neck","Hip","Body","Leg","Tail"} end, function() return CFG.AimPart~="" and CFG.AimPart or "Hitbox" end, function(opt) CFG.AimPart=opt; saveCfg() end, 13)
	mkSlider(a,"Aim Smoothness","AimSmooth",0,1,14)
	mkLabel(a,"Auto Hit is Head-only: it predicts the live Head while chasing with real W + Shift, then clicks and reports that exact Head until the target is gone. No S, glide, or teleport.",15)
end
do local p=Pages["PvP"]
	local _,d=mkSec(p,"Damage",1)
		...
		mkToggle(d,"Auto Lock Attacker (invisible, on hit)","AutoLockAttacker",6)
...
do local p=Pages["Survival"]
	...
	mkLabel(f,"Hold W to keep PE's native Run speed active. Stamina and exhaustion are repaired before physics; no CFrame, glide, velocity, or teleport movement.",2)
...
do local p=Pages["Growth"]
	...
	if not _G.PE_HIDE_LITE then
		...
		mkTextbox(fw,"Food multiplier (1-10M)","FoodMultiplierX",3,true)
		mkLabel(fw,"Type 1-10000000, then press E normally near food. Each Bite uses one guarded 4-call pulse, cancels its queue, and clears eating slowdown immediately.")
		mkDropdown(fw,"Pro Food diet",function() return {"Auto","Herbivore","Carnivore"} end,function() return CFG.InfFoodDiet or "Auto" end,function(opt) CFG.InfFoodDiet=opt; __gg.MH_foodProbeCursor=0; __gg.MH_foodReplicaState={preferred={},fallback={},at=0}; __gg.MH_infFoodTargetsCache=nil; __gg.MH_foodDietReplicaState=nil; saveCfg() end,6)
		mkToggle(fw,"INF Water","InfWater",7)
		mkBtn(fw,"Instant Corpse TP",function() if __gg.MH_corpseClick then __gg.MH_corpseClick() else notify("Corpse TP","Corpse scanner is still loading.") end end,8)
		mkBtn(fw,"Teleport Back",function() if __gg.MH_corpseBack then __gg.MH_corpseBack() end end,9)
	end
...
-- Prior Extinction's dedicated Sandbox place. Matchmaking is kept in one isolated tab so it never touches the
-- in-map CFrame teleport controller or its anti-snapback state.
__gg.MH_SANDBOX_PLACE=13700909394
__gg.MH_joinPublicPlace=function(placeId,randomInstance)
	if __gg.MH_serverHopBusy then notify("Sandbox","A server teleport is already starting."); return end
	__gg.MH_serverHopBusy=true
	task.spawn(function()
		local moved=false; local ok=true
		if randomInstance then
			ok=pcall(function()
				local raw=game:HttpGetAsync("https://games.roblox.com/v1/games/"..tostring(placeId).."/servers/Public?sortOrder=Asc&limit=100")
				local data=HttpService:JSONDecode(raw); local choices={}
				for _,srv in ipairs(data.data or {}) do if srv.id~=game.JobId and (tonumber(srv.playing) or 0)<(tonumber(srv.maxPlayers) or 0) then choices[#choices+1]=srv.id end end
				if #choices>0 then moved=true; TeleportSvc:TeleportToPlaceInstance(placeId,choices[math.random(1,#choices)],LP) end
			end)
		end
		if not moved and ok then moved=pcall(function() TeleportSvc:Teleport(placeId,LP) end) end
		if not ok or not moved then __gg.MH_serverHopBusy=false; notify("Sandbox","No open Sandbox server was returned. Try again in a moment.") else task.delay(8,function() __gg.MH_serverHopBusy=false end) end
	end)
end
do local p=Pages["Sandbox"]
	local _,s=mkSec(p,"Sandbox Servers",1)
	mkBtn(s,"Teleport to Sandbox server",function() __gg.MH_joinPublicPlace(__gg.MH_SANDBOX_PLACE,false) end,1)
	mkBtn(s,"Teleport to a random Sandbox server",function() __gg.MH_joinPublicPlace(__gg.MH_SANDBOX_PLACE,true) end,2)
	mkLabel(s,"Uses the official Prior Extinction Sandbox place and Roblox public-server matchmaking.",3)
end
...
-- Fast local stamina pin. The native-Run controller below owns the only remote keepalive, avoiding two overlapping
-- report loops. Incoming ReplicaSet is already corrected before PE's exhaustion listener sees a zero value.
task.spawn(function() while RUNNING do
	if alive() and CFG.InfStam then
		pcall(function()
			local observed=MHNEED.lowest("stamina",false); if observed~=nil then __gg.MH_stamObservedCurrent=observed; __gg.MH_stamLowestCurrent=observed; __gg.MH_stamObservedAt=tick(); local known=MHNEED.maxFor("stamina"); if known then __gg.MH_stamObserveLow(observed,known,"fast pin") end end
			local maximum,changed=MHNEED.pinStamina(); __gg.MH_stamPinState=maximum and ("max "..tostring(maximum)..(changed and " pinned" or " held")) or "waiting for stamina max"
			local rep=csReplica(); local data=(rep and rep.Data) or __gg.MH_incomingReplicaRoot; local seen={}
			local function clearExhaustion(tb,depth)
				if type(tb)~="table" or seen[tb] or depth>6 then return end; seen[tb]=true
				for key,value in pairs(tb) do local n=tostring(key):lower():gsub("[^%w]","")
					if (n:find("exhaust",1,true) or n:find("fatigu",1,true) or n=="tired") then
						if type(value)=="boolean" then tb[key]=false elseif type(value)=="number" then tb[key]=0 end
					elseif (n=="canrun" or n=="cansprint") and type(value)=="boolean" then tb[key]=true
					elseif type(value)=="table" then clearExhaustion(value,depth+1) end
				end
			end
			clearExhaustion(data,0); clearExhaustion(CharacterState,0)
		end)
		task.wait(0.05)
	else task.wait(0.35) end
end end)
...
conn(UIS.InputBegan:Connect(function(input, gp)
	...
	-- reaches the namecall hook first. Pro Food activates its own locked prompt only when its threshold is reached.
	if CFG.FoodMultiplier then return end
	__gg.MH_lastE = tick()
	if not alive() then return end
...
do
	...
	local function pinWB(stats,maxs)
		...
		-- WellbeingData and WellbeingGui define these as 0-100 percentages. Most live Wellbeing replicas do not expose a
		-- parallel MaxStats table, so 100 is the decompile-verified maximum rather than a guessed species capacity.
		for _,k in ipairs(WB_MAX) do local mx=(type(maxs)=="table" and tonumber(maxs[k])) or 100; if type(stats[k])=="number" and mx>0 then stats[k]=mx end end
		for _,k in ipairs(WB_ZERO) do if type(stats[k])=="number" then stats[k]=0 end end
	end
	local function pinBuffers(timers)
		if type(timers)~="table" then return end
		for k,v in pairs(timers) do if type(v)=="number" then timers[k]=math.max(v,1200) end end
	end
	...
	task.spawn(function() while RUNNING do
		if CFG.GodMode and alive() then
			pcall(function()
				...
				__gg.MH_wellbeingFound=rep~=nil; pinWB(sav and sav.Stats,sav and (sav.MaxStats or sav.Max)); pinBuffers(sav and sav.BufferTimers)
...
-- Speed Hack is independent. Infinite Stamina never uses this slider or writes assembly velocity.
...
-- INF STAMINA v8.17 — W-driven native ALWAYS RUN. PE keeps Run=true, incoming stamina drain is corrected before movement
-- listeners execute, and exhaustion slowdowns are restored to this dinosaur's own learned run speed. There is no
-- CFrame/velocity/body-mover drive, no synthetic Shift, and no HUD ∞ text replacement.
__gg.MH_stamRestoreWalkSpeed=function()
	__gg.MH_stamDriveSpeed=0; __gg.MH_stamBoostSpeed=0; __gg.MH_stamWasMoving=false
end
__gg.MH_stamKeyDown=function(name)
	local key=Enum.KeyCode[name]; local physical=false
	if key then pcall(function() physical=UIS:IsKeyDown(key) end) end
	return physical or ((__gg.MH_autoHitHeld or {})[name]==true)
end
__gg.MH_stamStopOwnedVelocity=function()
	-- This feature owns no velocity. Clearing state must never zero real keyboard momentum.
	__gg.MH_stamWasMoving=false; __gg.MH_stamDriveSpeed=0; __gg.MH_stamBoostSpeed=0
end
__gg.MH_refreshStamSpeedRefs=function(force)
	local model=getMyModel(); if not model then return end
	local changed=__gg.MH_stamSpeedModel~=model
	if changed then
		if type(__gg.MH_disconnectStamWatchers)=="function" then pcall(__gg.MH_disconnectStamWatchers) end
		__gg.MH_stamSpeedModel=model; __gg.MH_stamSpeedHumanoid=nil; __gg.MH_stamLearnedRunSpeed=nil; __gg.MH_stamLearnedWalkSpeed=nil
		__gg.MH_stamSpeedAttrs={}; __gg.MH_stamSpeedValues={}; __gg.MH_stamRuntimeAttrs={}; __gg.MH_stamRuntimeValues={}; __gg.MH_stamExhaustRefs={}
	end
	if not force and not changed and tick()-(__gg.MH_stamSpeedScanAt or 0)<2 then return end; __gg.MH_stamSpeedScanAt=tick()
	local h=hum(); if h and h.Parent then __gg.MH_stamSpeedHumanoid=h end
	local targets,seen={},{ }
	local function add(inst) if inst and typeof(inst)=="Instance" and not seen[inst] then seen[inst]=true; targets[#targets+1]=inst end end
	add(model); add(hrp()); add(model:FindFirstChild("MeshModel")); add(model:FindFirstChild("RootPart",true)); add(model:FindFirstChild("TurningAnimation",true)); add(model:FindFirstChild("Body",true))
	local scanned=0; for _,inst in ipairs(model:GetDescendants()) do scanned+=1; if scanned>650 then break end; add(inst) end
	local function speedNameOf(key)
		local name=tostring(key):lower():gsub("[^%w]","")
		if name:find("attack",1,true) or name:find("animation",1,true) or name:find("turn",1,true) or name:find("rotation",1,true) or name:find("swim",1,true) or name:find("fly",1,true) then return false end
		return name:find("walkspeed",1,true) or name:find("movespeed",1,true) or name:find("runspeed",1,true) or name:find("sprintspeed",1,true) or name=="speed" or name=="speedmultiplier" or name=="movementmultiplier" or name=="locomotionmultiplier"
	end
	local function staminaNameOf(key,context)
		local name=tostring(key):lower():gsub("[^%w]",""); local where=tostring(context or ""):lower():gsub("[^%w]","")
		if name:find("max",1,true) or name:find("capacity",1,true) or name:find("drain",1,true) or name:find("rate",1,true) or name:find("regen",1,true) or name:find("cost",1,true) or name:find("mult",1,true) then return false end
		if name=="stamina" or name=="stam" or name=="energy" or name=="endurance" or name=="vigor" or name=="currentstamina" or name=="staminacurrent" or name=="currentenergy" then return true end
		return (name=="current" or name=="value" or name=="amount" or name=="level" or name=="delta") and (where:find("stam",1,true) or where:find("energy",1,true) or where:find("endurance",1,true))
	end
	local function contextOf(inst)
		local names={}; local p=inst
		for _=1,5 do if not p or p==model.Parent then break end; names[#names+1]=p.Name; p=p.Parent end
		return table.concat(names,".")
	end
	local existing={}; for _,row in ipairs(__gg.MH_stamSpeedAttrs or {}) do if row.inst and row.inst.Parent then existing[row.inst]=existing[row.inst] or {}; existing[row.inst][row.key]=row end end
	local rows={}; for _,inst in ipairs(targets) do local ok,attrs=pcall(function() return inst:GetAttributes() end); if ok and type(attrs)=="table" then for key,value in pairs(attrs) do
		if speedNameOf(key) and type(value)=="number" and value>0 and value<500 then
			local row=(existing[inst] and existing[inst][key]) or {inst=inst,key=key,run=nil,walk=nil}; local normalized=tostring(key):lower():gsub("[^%w]","")
			row.current=value; row.high=math.max(tonumber(row.high) or 0,value); row.multiplier=normalized:find("multiplier",1,true)~=nil or normalized:find("modifier",1,true)~=nil
			if (normalized:find("run",1,true) or normalized:find("sprint",1,true)) and not row.run then row.run=value end
			rows[#rows+1]=row
		end
	end end end
	__gg.MH_stamSpeedAttrs=rows
	local oldValues={}; for _,row in ipairs(__gg.MH_stamSpeedValues or {}) do if row.inst and row.inst.Parent then oldValues[row.inst]=row end end
	local valueRows={}; for _,inst in ipairs(targets) do if (inst:IsA("NumberValue") or inst:IsA("IntValue")) and speedNameOf(inst.Name) then
		local value=tonumber(inst.Value); if value and value>0 and value<500 then local row=oldValues[inst] or {inst=inst,run=nil,walk=nil}; local normalized=inst.Name:lower():gsub("[^%w]",""); row.current=value; row.high=math.max(tonumber(row.high) or 0,value); row.multiplier=normalized:find("multiplier",1,true)~=nil or normalized:find("modifier",1,true)~=nil; if (normalized:find("run",1,true) or normalized:find("sprint",1,true)) and not row.run then row.run=value end; valueRows[#valueRows+1]=row end
	end end
	__gg.MH_stamSpeedValues=valueRows
	local oldRuntimeAttrs={}; for _,row in ipairs(__gg.MH_stamRuntimeAttrs or {}) do if row.inst and row.inst.Parent then oldRuntimeAttrs[row.inst]=oldRuntimeAttrs[row.inst] or {}; oldRuntimeAttrs[row.inst][row.key]=row end end
	local runtimeAttrs={}; local exhaustRefs={}
	for _,inst in ipairs(targets) do local context=contextOf(inst); local ok,attrs=pcall(function() return inst:GetAttributes() end); if ok and type(attrs)=="table" then for key,value in pairs(attrs) do
		local normalized=tostring(key):lower():gsub("[^%w]","")
		if type(value)=="number" and staminaNameOf(key,context) then local row=(oldRuntimeAttrs[inst] and oldRuntimeAttrs[inst][key]) or {inst=inst,key=key,high=0}; row.high=math.max(tonumber(row.high) or 0,value); runtimeAttrs[#runtimeAttrs+1]=row
		elseif (type(value)=="boolean" or type(value)=="number") and (normalized:find("exhaust",1,true) or normalized:find("fatigu",1,true) or normalized=="tired" or normalized=="canrun" or normalized=="cansprint") then exhaustRefs[#exhaustRefs+1]={mode="attr",inst=inst,key=key,positive=normalized=="canrun" or normalized=="cansprint"} end
	end end end
	__gg.MH_stamRuntimeAttrs=runtimeAttrs
	local oldRuntimeValues={}; for _,row in ipairs(__gg.MH_stamRuntimeValues or {}) do if row.inst and row.inst.Parent then oldRuntimeValues[row.inst]=row end end
	local runtimeValues={}; for _,inst in ipairs(targets) do if inst:IsA("NumberValue") or inst:IsA("IntValue") then local context=contextOf(inst.Parent); local value=tonumber(inst.Value)
		if value and staminaNameOf(inst.Name,context) then local row=oldRuntimeValues[inst] or {inst=inst,high=0}; row.high=math.max(tonumber(row.high) or 0,value); runtimeValues[#runtimeValues+1]=row
		else local normalized=inst.Name:lower():gsub("[^%w]",""); if normalized:find("exhaust",1,true) or normalized:find("fatigu",1,true) or normalized=="tired" then exhaustRefs[#exhaustRefs+1]={mode="value",inst=inst,positive=false} end end
	end end
	__gg.MH_stamRuntimeValues=runtimeValues; __gg.MH_stamExhaustRefs=exhaustRefs
end
__gg.MH_disconnectStamWatchers=function()
	for _,connection in ipairs(__gg.MH_stamWatchConns or {}) do pcall(function() connection:Disconnect() end) end
	__gg.MH_stamWatchConns={}; __gg.MH_stamWatchModel=nil; __gg.MH_stamWatchAt=0
end
__gg.MH_stamRepairMotionNow=function(force)
	if not (RUNNING and CFG.InfStam and alive()) or __gg.MH_stamWatchWriting then return end
	__gg.MH_stamWatchWriting=true
	pcall(function()
		local runHeld=__gg.MH_stamKeyDown("W") or __gg.MH_stamKeyDown("LeftShift") or UIS:IsKeyDown(Enum.KeyCode.RightShift)
		local recovering=force or tick()<(__gg.MH_stamZeroRecoveryUntil or 0) or tick()<(__gg.MH_eatRecoveryUntil or 0)
		-- W is the run demand. Restore the speed nearly immediately even before a zero-stamina event, so a stale
		-- exhaustion value such as 13/16 cannot remain just above the older 80% repair threshold.
		local restoreRatio=(runHeld or recovering) and 0.98 or 0.8
		local maximum=tonumber(MHNEED.max and MHNEED.max.stamina) or tonumber(__gg.MH_stamAuthoritativeMax) or tonumber(__gg.MH_needHighWater and __gg.MH_needHighWater.stamina)
		for _,row in ipairs(__gg.MH_stamRuntimeAttrs or {}) do if row.inst and row.inst.Parent then local value=row.inst:GetAttribute(row.key); if type(value)=="number" then row.high=math.max(tonumber(row.high) or 0,value); local target=maximum or row.high; if target and target>0 and value<target then __gg.MH_stamObserveLow(value,target,"dino attribute"); row.inst:SetAttribute(row.key,target) end end end end
		for _,row in ipairs(__gg.MH_stamRuntimeValues or {}) do if row.inst and row.inst.Parent then local value=tonumber(row.inst.Value); if value then row.high=math.max(tonumber(row.high) or 0,value); local target=maximum or row.high; if target and target>0 and value<target then __gg.MH_stamObserveLow(value,target,"dino value"); row.inst.Value=target end end end end
		if MHNEED.pinStaminaFast then MHNEED.pinStaminaFast() end
		for _,row in ipairs(__gg.MH_stamExhaustRefs or {}) do if row.inst and row.inst.Parent then
			if row.mode=="attr" then local value=row.inst:GetAttribute(row.key); if type(value)=="boolean" then row.inst:SetAttribute(row.key,row.positive==true) elseif type(value)=="number" and value~=0 then row.inst:SetAttribute(row.key,0) end
			elseif row.mode=="value" and tonumber(row.inst.Value)~=0 then row.inst.Value=0 end
		end end
		if not (runHeld or recovering) then return end
		local runFallback=math.max(tonumber(__gg.MH_stamLearnedRunSpeed) or 0,tonumber(CFG.InfStamSpeed) or 16)
		local h=__gg.MH_stamSpeedHumanoid; if h and h.Parent then local current=tonumber(h.WalkSpeed); local target=runHeld and runFallback or tonumber(__gg.MH_stamLearnedWalkSpeed); if current and target and target>0 and current<target*restoreRatio then h.WalkSpeed=target; __gg.MH_stamSpeedFixes=(__gg.MH_stamSpeedFixes or 0)+1 end end
		for _,row in ipairs(__gg.MH_stamSpeedAttrs or {}) do if row.inst and row.inst.Parent then local value=row.inst:GetAttribute(row.key); if type(value)=="number" then local target=row.multiplier and math.max(1,tonumber(row.run) or tonumber(row.walk) or tonumber(row.high) or 1) or (runHeld and (row.run or row.high) or row.walk); if target and value<target*restoreRatio then row.inst:SetAttribute(row.key,target); __gg.MH_stamSpeedFixes=(__gg.MH_stamSpeedFixes or 0)+1 end end end end
		for _,row in ipairs(__gg.MH_stamSpeedValues or {}) do if row.inst and row.inst.Parent then local value=tonumber(row.inst.Value); if value then local target=row.multiplier and math.max(1,tonumber(row.run) or tonumber(row.walk) or tonumber(row.high) or 1) or (runHeld and (row.run or row.high) or row.walk); if target and value<target*restoreRatio then row.inst.Value=target; __gg.MH_stamSpeedFixes=(__gg.MH_stamSpeedFixes or 0)+1 end end end end
		for _,row in pairs(__gg.MH_moveIncomingPaths or {}) do local baseline=tonumber(row.baseline); if baseline and type(row.path)=="table" then MH_applyIncomingPath(row.path,baseline) end end
	end)
	__gg.MH_stamWatchWriting=false
end
__gg.MH_refreshStamWatchers=function(force)
	local model=getMyModel(); if not model then return end
	if not force and __gg.MH_stamWatchModel==model and tick()-(__gg.MH_stamWatchAt or 0)<2.1 then return end
	__gg.MH_disconnectStamWatchers(); __gg.MH_stamWatchModel=model; __gg.MH_stamWatchAt=tick()
	local watched={}; local function addConnection(signal)
		local ok,connection=pcall(function() return signal:Connect(function()
			if not (RUNNING and CFG.InfStam) or __gg.MH_stamWatchWriting then return end
			local low=MHNEED.lowestFast and MHNEED.lowestFast("stamina"); local maximum=tonumber(MHNEED.max and MHNEED.max.stamina) or tonumber(__gg.MH_stamAuthoritativeMax) or tonumber(__gg.MH_needHighWater and __gg.MH_needHighWater.stamina)
			if low and maximum then __gg.MH_stamObserveLow(low,maximum,"change signal") end
			__gg.MH_stamRepairMotionNow(false)
		end) end)
		if ok and connection then __gg.MH_stamWatchConns[#__gg.MH_stamWatchConns+1]=connection end
	end
	local function watchAttr(inst,key) if not (inst and inst.Parent) then return end; local bucket=watched[inst] or {}; watched[inst]=bucket; if bucket[key] then return end; bucket[key]=true; pcall(function() addConnection(inst:GetAttributeChangedSignal(key)) end) end
	local function watchValue(inst) if not (inst and inst.Parent) then return end; local bucket=watched[inst] or {}; watched[inst]=bucket; if bucket.__value then return end; bucket.__value=true; addConnection(inst.Changed) end
	local h=__gg.MH_stamSpeedHumanoid; if h and h.Parent then pcall(function() addConnection(h:GetPropertyChangedSignal("WalkSpeed")) end) end
	for _,ref in ipairs(MHNEED.refs.stamina or {}) do if ref.mode=="attr" then watchAttr(ref.inst,ref.key) elseif ref.mode=="value" then watchValue(ref.inst) end end
	for _,row in ipairs(__gg.MH_stamRuntimeAttrs or {}) do watchAttr(row.inst,row.key) end
	for _,row in ipairs(__gg.MH_stamRuntimeValues or {}) do watchValue(row.inst) end
	for _,row in ipairs(__gg.MH_stamSpeedAttrs or {}) do watchAttr(row.inst,row.key) end
	for _,row in ipairs(__gg.MH_stamSpeedValues or {}) do watchValue(row.inst) end
	for _,row in ipairs(__gg.MH_stamExhaustRefs or {}) do if row.mode=="attr" then watchAttr(row.inst,row.key) else watchValue(row.inst) end end
end
conn(UIS.InputBegan:Connect(function(input,gp)
	if gp or (input.KeyCode~=Enum.KeyCode.W and input.KeyCode~=Enum.KeyCode.LeftShift and input.KeyCode~=Enum.KeyCode.RightShift) then return end
...
conn(UIS.InputEnded:Connect(function(input)
	if input.KeyCode~=Enum.KeyCode.W and input.KeyCode~=Enum.KeyCode.LeftShift and input.KeyCode~=Enum.KeyCode.RightShift then return end
	local stillHeld=UIS:IsKeyDown(Enum.KeyCode.W) or UIS:IsKeyDown(Enum.KeyCode.LeftShift) or UIS:IsKeyDown(Enum.KeyCode.RightShift) or ((__gg.MH_autoHitHeld or {}).W==true) or ((__gg.MH_autoHitHeld or {}).LeftShift==true)
	__gg.MH_stamInputHeld=stillHeld; __gg.MH_stamRunRequested=CFG.InfStam and stillHeld or false
	if CFG.InfStam then task.defer(function() pcall(__gg.MH_syncRun,stillHeld); if not stillHeld then pcall(__gg.MH_stamStopOwnedVelocity) end end) end
end))
-- Run before physics so a direct local stamina Value/attribute cannot sit at zero long enough for PE to enter its
-- exhausted locomotion state. This path touches only already-resolved stamina references and owns no movement force.
conn(RunService.Stepped:Connect(function()
	if not (CFG.InfStam and alive()) then return end
	pcall(function()
		local low=MHNEED.lowestFast("stamina"); local maximum=tonumber(MHNEED.max and MHNEED.max.stamina) or tonumber(__gg.MH_stamAuthoritativeMax) or tonumber(__gg.MH_needHighWater and __gg.MH_needHighWater.stamina)
		if low~=nil then __gg.MH_stamLowestCurrent=low; if maximum then __gg.MH_stamObserveLow(low,maximum,"pre-physics") end end
		MHNEED.pinStaminaFast()
		__gg.MH_stamRepairMotionNow(tick()<(__gg.MH_stamZeroRecoveryUntil or 0))
	end)
end))
conn(RunService.Heartbeat:Connect(function()
	__gg.MH_stamDriveSpeed=0; __gg.MH_stamBoostSpeed=0
	if __gg.MH_stamBV then pcall(function() __gg.MH_stamBV:Destroy() end); __gg.MH_stamBV=nil end
	if not alive() then __gg.MH_stamWasMoving=false; return end
	pcall(function()
		local nativeDemand=__gg.MH_stamKeyDown("LeftShift") or UIS:IsKeyDown(Enum.KeyCode.RightShift)
		local runHeld=nativeDemand or (CFG.InfStam and __gg.MH_stamKeyDown("W"))
		...
		if runHeld and root and speed>=4 and speed<=180 then __gg.MH_nativeRunSpeed=math.max(tonumber(__gg.MH_nativeRunSpeed) or 0,speed) end
		__gg.MH_refreshStamSpeedRefs(false); if CFG.InfStam then __gg.MH_refreshStamWatchers(false) end
		local current=MHNEED.lowest("stamina",false); local maximum=MHNEED.maxFor("stamina"); __gg.MH_stamLowestCurrent=current
		if current~=nil and maximum then __gg.MH_stamObserveLow(current,maximum,"heartbeat") end
		local healthy=not maximum or current==nil or current>maximum*0.15
		local recovering=tick()<(__gg.MH_eatRecoveryUntil or 0)
		local h=__gg.MH_stamSpeedHumanoid
		if h and h.Parent then local walk=tonumber(h.WalkSpeed)
			if runHeld and walk and walk>0 and walk<500 and (healthy or not CFG.InfStam) then __gg.MH_stamLearnedRunSpeed=math.max(tonumber(__gg.MH_stamLearnedRunSpeed) or 0,walk) end
			if not runHeld and not recovering and walk and walk>0 and walk<500 then __gg.MH_stamLearnedWalkSpeed=math.max(tonumber(__gg.MH_stamLearnedWalkSpeed) or 0,walk) end
			local learned=(CFG.InfStam and runHeld and tonumber(__gg.MH_stamLearnedRunSpeed)) or (recovering and tonumber(__gg.MH_stamLearnedWalkSpeed))
			if learned and walk and walk<learned*0.8 then h.WalkSpeed=learned; __gg.MH_stamSpeedFixes=(__gg.MH_stamSpeedFixes or 0)+1 end
		end
		for _,row in ipairs(__gg.MH_stamSpeedAttrs or {}) do if row.inst and row.inst.Parent then local value=row.inst:GetAttribute(row.key); if type(value)=="number" then
			if value>0 and value<500 and healthy then row.high=math.max(tonumber(row.high) or 0,value) end
			if runHeld and value>0 and value<500 and (healthy or not CFG.InfStam) then row.run=math.max(tonumber(row.run) or 0,value) end
			if not runHeld and not recovering and value>0 and value<500 then row.walk=math.max(tonumber(row.walk) or 0,value) end
			local target=(CFG.InfStam and runHeld and (row.run or row.high)) or (recovering and (row.walk or row.run or row.high)); if target and value<target*0.8 then row.inst:SetAttribute(row.key,target); __gg.MH_stamSpeedFixes=(__gg.MH_stamSpeedFixes or 0)+1 end
		end end end
		for _,row in ipairs(__gg.MH_stamSpeedValues or {}) do if row.inst and row.inst.Parent then local value=tonumber(row.inst.Value); if value then
			if value>0 and value<500 and healthy then row.high=math.max(tonumber(row.high) or 0,value) end
			if runHeld and value>0 and value<500 and (healthy or not CFG.InfStam) then row.run=math.max(tonumber(row.run) or 0,value) end
			if not runHeld and not recovering and value>0 and value<500 then row.walk=math.max(tonumber(row.walk) or 0,value) end
			local target=(CFG.InfStam and runHeld and (row.run or row.high)) or (recovering and (row.walk or row.run or row.high)); if target and value<target*0.8 then row.inst.Value=target; __gg.MH_stamSpeedFixes=(__gg.MH_stamSpeedFixes or 0)+1 end
		end end end
		if not CFG.InfStam then __gg.MH_stamRunRequested=false; return end
		MHNEED.pinStaminaFast(); __gg.MH_stamRepairMotionNow(tick()<(__gg.MH_stamZeroRecoveryUntil or 0))
		if not __gg.MH_incomingNeedInstalled and tick()-(__gg.MH_incomingNeedTryAt or 0)>2 then __gg.MH_incomingNeedTryAt=tick(); pcall(__gg.MH_installIncomingNeedGuard) end
		if tick()-(__gg.MH_stamHardReportAt or 0)>=0.18 then __gg.MH_stamHardReportAt=tick(); MHNEED.pinStamina(); MHNEED.report("stamina",false); MHNEED.reportStaminaAll(false) end
		__gg.MH_stamRunRequested=runHeld
		local syncEvery=tick()<(__gg.MH_stamZeroRecoveryUntil or 0) and 0.12 or 0.45
		if runHeld and tick()-(__gg.MH_stamSyncAt or 0)>=syncEvery then __gg.MH_stamSyncAt=tick(); pcall(__gg.MH_syncRun,true) end
		if runHeld then __gg.MH_nativeRunActive=true; __gg.MH_stamWasMoving=true; __gg.MH_stamDriveSpeed=tonumber(__gg.MH_stamLearnedRunSpeed) or tonumber(__gg.MH_nativeRunSpeed) or 16; __gg.MH_stamBoostSpeed=__gg.MH_stamDriveSpeed; __gg.MH_stamReportState="W Run=true | incoming pin | speed guard"
		else __gg.MH_stamWasMoving=false end
	end)
end))
...
local function collectCorpses()
	...
	-- Preserve discovery order: real dead bodies/meat from anywhere on the map come before empty spawn markers. Sorting
	-- by player distance made every button press choose the same nearby marker and hid far-map corpses.
	return out
end
...
-- The old YES/NO popup is deliberately gone. Destroy a stale copy left by an earlier hot-reload too.
pcall(function()
	local pg=LP:FindFirstChildOfClass("PlayerGui"); local old=pg and pg:FindFirstChild("MH_CorpseTP"); if old then old:Destroy() end
	if typeof(gethui)=="function" then local h=gethui(); old=h and h:FindFirstChild("MH_CorpseTP"); if old then old:Destroy() end end
end)
...
local function MH_hopFire(goalCF)
	...
	local sent=false; local ok=pcall(function()
		...
		-- This id is cleared whenever the active dinosaur identity changes, so it remains valid for the life of this
		-- dinosaur and does not need the old four-second expiry that made one-click teleports silently unsynchronised.
		local id=__gg.MH_physicsReplicaId
...
__gg.MH_safeTeleport=function(target, options)
	...
	-- Move the dinosaur so its real steering/physics root lands on the requested CFrame. Model:PivotTo(goal) alone
	-- places the model pivot there, which can leave TurningAnimation.Body several studs away and make a successful TP
	-- look like a failed one. Preserve the current model-pivot-to-root offset on every move.
	local function moveRootTo(cf)
		local current=getMyModel(); local rr=hrp(); if not rr then return false end
		if current and current:IsA("Model") then
			local pivot=current:GetPivot(); local offset=pivot:ToObjectSpace(rr.CFrame); current:PivotTo(cf*offset:Inverse())
		else rr.CFrame=cf end
		return true
	end
	...
	if CharacterState then pcall(function() CharacterState.FallDamageImmunity=true end) end
	local instant=options.instant==true
	local safe=not instant and (CFG.SafeTP==true or options.paced==true); local synced=CFG.BypassTP==true
	if safe then pcall(function() LP:RequestStreamAroundAsync(pos,2) end) end
	-- Corpse TP previously jumped 120 studs every 0.05s, emitted a raw CFrame remote for every hop, then repeated
	-- that remote through the settle hold. That burst is what made the server kick. Paced mode moves the whole model
	-- in short streamed steps and allows at most one verified physics-replica sync at the destination.
	local stepDistance=math.clamp(tonumber(options.stepDistance) or 28,12,80)
	local hops=safe and math.clamp(math.ceil(delta/stepDistance),1,420) or 1
	local stepDelay=math.clamp(tonumber(options.stepDelay) or 0.075,0.04,0.2)
	__gg.MH_rescueMute=tick()+math.max(4,hops*stepDelay+(tonumber(options.settle) or 1.25)+3)
	for i=1,hops do
		if seq~=(__gg.MH_tpSeq or 0) or not featureValid() then return false end
		local step=CFrame.new(from:Lerp(pos,i/hops))
		if safe and i<hops then
			pcall(function() moveRootTo(step); local rr=hrp(); if rr then rr.AssemblyLinearVelocity=Vector3.zero; rr.AssemblyAngularVelocity=Vector3.zero end end)
			if i%18==0 then pcall(function() LP:RequestStreamAroundAsync(step.Position,0.5) end) end
			task.wait(stepDelay)
		end
	end
	local movedOk,moved=pcall(moveRootTo,goal)
	if not movedOk or not moved then return false end
	...
	if not options.noHold then task.spawn(function()
		local untilT=tick()+math.clamp(tonumber(options.settle) or 1.25,0.2,3)
		local corrections=0
		while RUNNING and seq==(__gg.MH_tpSeq or 0) and featureValid() and tick()<untilT and corrections<2 do
			local rr=hrp()
			if rr and (rr.Position-pos).Magnitude>(tonumber(options.tolerance) or 7) then
				corrections+=1; if synced and corrections==1 then MH_hopFire(goal) end
...
local function tpToCorpse(part,feature,token)
	...
	-- Ask StreamingEnabled for the destination before the instant pivot. This is bounded and does not turn Corpse TP
	-- into the old multi-hop glide; far-map corpse/spawn targets can still load around the landing point.
	pcall(function() LP:RequestStreamAroundAsync(np,0.35) end)
...
-- One-shot map-wide corpse/dead-player teleport. Each click advances through all live bodies first, then every
-- CorpseSpawns marker; invalid/void entries are skipped without resetting the map cursor.
local function doNextCorpse(token)
	...
	corpseList=collectCorpses()
	if not active() then return false end
	if #corpseList==0 then notify("Corpse TP","No corpse spawn or dead-player corpse is currently streamed."); return false end
	if not carnOrigin then local r=hrp(); if r then carnOrigin=r.Position end end
	...
	repeat
		...
		if part and part.Parent then ok = (tpToCorpse(part,"CarnMeatTP",token)==true) end
		if not ok then carnBusy=false end
	until ok or tries>#corpseList
	if not ok then corpseList={}; if active() then notify("Corpse TP","No safe corpse destination was available.") end; return false end
	if not active() then return false end
	notify("Corpse TP","Teleported instantly to map target "..tostring(corpseIdx).." / "..tostring(#corpseList)..".")
	return true
end
__gg.MH_corpseClick=function()
	if not alive() or tick()-carnSpawnT<=5 or tick()<(__gg.MH_spawnGrace or 0) then notify("Corpse TP","Wait until your dinosaur finishes spawning."); return end
	if carnBusy then notify("Corpse TP","A corpse teleport is already running."); return end
	local r=hrp(); if not r then notify("Corpse TP","Your dinosaur root is not ready."); return end
	if not carnOrigin then carnOrigin=r.Position end; CFG.CarnMeatTP=true
...
__gg.MH_cancelCorpseTP=function()
	...
	if type(__gg.MH_tpFeatureGen)=="table" then __gg.MH_tpFeatureGen.CarnMeatTP=(__gg.MH_tpFeatureGen.CarnMeatTP or 0)+1 end
end
__gg.MH_corpseBack = function()   -- "Teleport Back" button -> return to where you were
	local o=carnOrigin; if not o then notify("Corpse TP","No saved spot yet—use Instant Corpse TP first."); return end
	__gg.MH_corpseHoldGoal = nil
	carnBusy = false
	local moved=__gg.MH_safeTeleport and __gg.MH_safeTeleport(CFrame.new(o),{settle=0.25,tolerance=8,instant=true,noHold=true})
...
__gg.MH_combatReady=function()
	local seq=__gg.MH_attackSequence; local id=MHNEED and MHNEED.replicaId and MHNEED.replicaId()
	return type(seq)=="table" and seq.identity==__gg.MH_identityKey and type(seq.register)=="table" and type(seq.attack)=="table" and seq.register[1]==id and seq.attack[1]==id
end
...
__gg.MH_autoHitDead=function(model)
	...
	local h=model:FindFirstChildOfClass("Humanoid"); if h and h.MaxHealth>0 then return h.Health<=0 end
	for _,name in ipairs({"Health","HP","Hitpoints","HitPoints"}) do local v=model:GetAttribute(name); if tonumber(v)~=nil then return tonumber(v)<=0 end end
	for _,name in ipairs({"Dead","IsDead","Died","Corpse","Ragdolled"}) do if model:GetAttribute(name)==true then return true end end
	return false
end
__gg.MH_autoHitHead=function(model)
	if not model then return nil end
	local cached=__gg.MH_autoHitHeadModel==model and __gg.MH_autoHitHeadBone or nil
	if cached and cached.Parent and cached:IsDescendantOf(model) and partPos(cached) then return cached end
	local best,bestScore=nil,-1; local scanned=0
	local function consider(item)
		if not (item:IsA("BasePart") or item:IsA("Bone") or item:IsA("Attachment")) then return end
		local name=item.Name:lower():gsub("[^%w]",""); local anatomy
		if name=="head" then anatomy=900
		elseif name:match("^head%d+$") or name:find("headbone",1,true) or name:find("headhitbox",1,true) then anatomy=700
		elseif name:find("skull",1,true) or name:find("crani",1,true) or name:find("jaw",1,true) then anatomy=300
		else return end
		local position=partPos(item); if not position then return end
		local score=anatomy+((item:IsA("Bone") or item:IsA("Attachment")) and 260 or 60)
		local parent=item.Parent; if parent and parent.Name:lower()=="head" then score+=100 end
		local p=item.Parent; local inMesh=false; local inHitbox=false; local inPhysics=false
		for _=1,8 do if not p or p==model.Parent then break end; local n=p.Name:lower(); if n=="meshmodel" then inMesh=true elseif n=="hitbox" or n=="hitboxpart" then inHitbox=true elseif n=="physics" then inPhysics=true end; p=p.Parent end
		if inMesh then score+=120 end; if inPhysics then score+=180 end; if inHitbox then score+=650 end
		if item:IsA("BasePart") and item:FindFirstChild(item.Name) then score-=260 end
		if score>bestScore then best,bestScore=item,score end
	end
	local hb=findHitboxContainer(model); if hb then consider(hb); for _,item in ipairs(hb:GetDescendants()) do consider(item) end end
	consider(model); for _,item in ipairs(model:GetDescendants()) do scanned+=1; if scanned>5000 then break end; consider(item) end
	if best then __gg.MH_autoHitHeadModel=model; __gg.MH_autoHitHeadBone=best; __gg.MH_autoHitHeadAt=tick() end
	return best
end
-- Auto Hit is deliberately head-only. Other aim tools still honor their dropdowns, but this feature never falls
-- back to a body/root hit while a newly streamed rig is missing its Head; it waits for the live Head instead.
__gg.MH_autoHitAim=function(model)
	return __gg.MH_autoHitHead(model)
end
__gg.MH_autoHitGroup=function() return "Head" end
...
__gg.MH_autoHitReleaseClicks=function()
	pcall(function() if typeof(mouse1release)=="function" then mouse1release() end end); pcall(function() if typeof(mouse2release)=="function" then mouse2release() end end)
	pcall(function() local cam=workspace.CurrentCamera; local size=cam and cam.ViewportSize or Vector2.new(800,600); VIM:SendMouseButtonEvent(size.X*0.5,size.Y*0.5,0,false,game,0); VIM:SendMouseButtonEvent(size.X*0.5,size.Y*0.5,1,false,game,0) end)
end
__gg.MH_autoHitReleaseMovement=function()
	...
	__gg.MH_autoHitDriveBV=nil; __gg.MH_autoHitDriveBG=nil; __gg.MH_autoHitMoveVector=nil; __gg.MH_autoHitReverseActive=false; __gg.MH_autoHitInContact=false; __gg.MH_autoHitProgressAt=nil; __gg.MH_autoHitLastDistance=nil; __gg.MH_autoHitLastRootPos=nil; __gg.MH_autoHitClicking=false
	-- Some executors queue key events one frame late. Repeat key-up only for keys this feature actually owned.
	if #owned>0 then for _,delay in ipairs({0,0.05,0.15}) do task.delay(delay,function() if not CFG.AutoHit or __gg.MH_autoHitManualClear or not __gg.MH_autoHitLocked then for _,name in ipairs(owned) do pcall(__gg.MH_autoHitSetKey,name,false) end end end) end end
	if not CFG.AutoHit then pcall(__gg.MH_autoHitReleaseClicks) end
end
__gg.MH_autoHitDriveMovement=function(target)
	...
	local me=hrp(); local bone=__gg.MH_autoHitAim(target); local position=partPos(bone); local now=tick()
	if position then
		local oldPosition=__gg.MH_autoHitHeadSamplePos; local oldAt=tonumber(__gg.MH_autoHitHeadSampleAt) or 0; local elapsed=now-oldAt
		if oldPosition and elapsed>0.015 and elapsed<0.35 then
			local raw=(position-oldPosition)/elapsed
			if raw.Magnitude<220 then local previous=__gg.MH_autoHitHeadVelocity; __gg.MH_autoHitHeadVelocity=(typeof(previous)=="Vector3" and previous or Vector3.zero):Lerp(raw,0.35) else __gg.MH_autoHitHeadVelocity=Vector3.zero end
		end
		__gg.MH_autoHitHeadSamplePos=position; __gg.MH_autoHitHeadSampleAt=now; __gg.MH_autoHitLastHeadPos=position; __gg.MH_autoHitLastHeadAt=now
	elseif now-(__gg.MH_autoHitLastHeadAt or 0)<=0.75 then position=__gg.MH_autoHitLastHeadPos
	else __gg.MH_autoHitSetStatus("Locked: "..target.Name.." | waiting for live Head"); __gg.MH_autoHitReleaseMovement(); return end
	-- A short stream gap may follow the last exact Head sample, but attacks remain disabled until the live Head returns.
	if not (me and position) then __gg.MH_autoHitReleaseMovement(); return end
	local myJaw=_findIn(getMyModel(),"Head") or _findIn(getMyModel(),"Jaw"); local origin=partPos(myJaw) or me.Position
	local distance=(position-origin).Magnitude; local contact=math.max(7,(tonumber(CFG.AutoHitFollowDistance) or 4)+3)
	local close=__gg.MH_autoHitInContact and distance<=contact+1.35 or distance<=contact
	local velocity=__gg.MH_autoHitHeadVelocity; local lead=close and 0 or math.clamp(distance/240,0.035,0.18)
	local steerPosition=position
	if typeof(velocity)=="Vector3" and velocity.Magnitude<220 then steerPosition=position+Vector3.new(velocity.X,0,velocity.Z)*lead end
	local delta=Vector3.new(steerPosition.X-origin.X,0,steerPosition.Z-origin.Z)
	-- PE resolves W from the active camera heading, while the old root-local A/D steering could strafe or circle away.
	-- Face a tiny prediction of the moving Head while travelling, then the exact Head at contact. Own only real W+Shift:
	-- no S, glide, root CFrame, body mover, or velocity is used, so PE keeps its native anti-rubber-band movement.
	local cam=workspace.CurrentCamera
	if cam and delta.Magnitude>0.05 then pcall(function()
		local eye=cam.CFrame.Position; local look=close and position or Vector3.new(steerPosition.X,eye.Y,steerPosition.Z)
		if (look-eye).Magnitude>0.05 then cam.CFrame=CFrame.lookAt(eye,look,Vector3.yAxis) end
	end) end
	local desired={W=not close,A=false,S=false,D=false,LeftShift=not close}
	__gg.MH_autoHitHeld=__gg.MH_autoHitHeld or {}
	...
	pcall(function() if __gg.MH_autoHitDriveBV then __gg.MH_autoHitDriveBV:Destroy() end; if __gg.MH_autoHitDriveBG then __gg.MH_autoHitDriveBG:Destroy() end end)
	__gg.MH_autoHitDriveBV=nil; __gg.MH_autoHitDriveBG=nil; __gg.MH_autoHitLastDistance=distance; __gg.MH_autoHitInContact=close
	__gg.MH_autoHitTrackBone=bone; __gg.MH_autoHitTrackUntil=now+0.2
end
__gg.MH_autoHitDrop=function()
	__gg.MH_autoHitGen=(__gg.MH_autoHitGen or 0)+1
	pcall(function() if __gg.MH_autoHitHighlight then __gg.MH_autoHitHighlight:Destroy() end end)
	__gg.MH_autoHitHighlight=nil; __gg.MH_autoHitOutlineSuppressed=false; __gg.MH_autoHitLocked=nil; __gg.MH_autoHitTrackBone=nil; __gg.MH_autoHitTrackUntil=0; __gg.MH_autoHitLastHeadPos=nil; __gg.MH_autoHitLastHeadAt=0; __gg.MH_autoHitHeadBone=nil; __gg.MH_autoHitHeadModel=nil; __gg.MH_autoHitHeadAt=0; __gg.MH_autoHitHeadSamplePos=nil; __gg.MH_autoHitHeadSampleAt=0; __gg.MH_autoHitHeadVelocity=Vector3.zero; __gg.MH_autoHitNativeReportAt=0; __gg.MH_autoHitNativeReportTarget=nil
	if __gg.MH_autoHitReleaseMovement then __gg.MH_autoHitReleaseMovement() end; if __gg.MH_autoHitReleaseClicks then __gg.MH_autoHitReleaseClicks() end
end
...
__gg.MH_autoHitLock=function(model,persistName,showOutline)
	...
	if persistName then showOutline=true end
	if showOutline~=nil then __gg.MH_autoHitOutlineSuppressed=showOutline==false elseif changed then __gg.MH_autoHitOutlineSuppressed=false end
	if __gg.MH_autoHitOutlineSuppressed then
		pcall(function() if __gg.MH_autoHitHighlight then __gg.MH_autoHitHighlight:Destroy() end end); __gg.MH_autoHitHighlight=nil
	elseif not (__gg.MH_autoHitHighlight and __gg.MH_autoHitHighlight.Parent==model) then
		pcall(function() if __gg.MH_autoHitHighlight then __gg.MH_autoHitHighlight:Destroy() end end)
...
__gg.MH_autoHitFindNamed=function(query)
	query=tostring(query or ""):lower():gsub("^%s+",""):gsub("%s+$",""):gsub("^@","")
	if query=="" then return nil end
	local mine=getMyModel(); local me=hrp(); local names={}; local best,bestDistance
	for _,player in ipairs(Players:GetPlayers()) do
		local username=player.Name:lower(); local display=tostring(player.DisplayName or ""):lower()
		if username:find(query,1,true) or display:find(query,1,true) then names[username]=true; if display~="" then names[display]=true end end
	end
	local function consider(model)
		if not (model and model:IsA("Model") and model~=mine) then return end
		local modelName=model.Name:lower(); local matched=modelName:find(query,1,true)~=nil or names[modelName]==true
		if not matched then for _,attribute in ipairs({"Owner","OwnerName","Player","PlayerName","Username","DisplayName"}) do
			local ok,value=pcall(function() return model:GetAttribute(attribute) end); if ok and type(value)=="string" then local lowered=value:lower(); if lowered:find(query,1,true) or names[lowered] then matched=true; break end end
		end end
		if not matched then return end
		local humanoid=model:FindFirstChildOfClass("Humanoid"); if (humanoid and humanoid.Health<=0) or __gg.MH_autoHitDead(model) then return end
		local root=getHitbox(model) or rootOf(model); if not root then return end
		local distance=me and dist(me.Position,root.Position) or 0
		if bestDistance==nil or distance<bestDistance then best,bestDistance=model,distance end
	end
	for _,model in ipairs(charModels()) do consider(model) end
	for _,player in ipairs(Players:GetPlayers()) do if names[player.Name:lower()] then
		if player.Character then consider(player.Character) end
		if type(__gg.MH_targetModelFor)=="function" then local resolved; pcall(function() resolved=__gg.MH_targetModelFor(player) end); consider(resolved) end
	end end
	return best
end
__gg.MH_autoHitTarget=function()
	...
	local aim=target and __gg.MH_autoHitAim(target); local position=partPos(aim); if not position then __gg.MH_autoHitSetStatus("Locked, waiting for live Head: "..target.Name); return nil end
	local distance=dist(me.Position,position); local screen,visible=cam:WorldToViewportPoint(position); local boneName=aim and aim.Name or "Head"
...
__gg.MH_autoHitClickButton=function(button,x,y)
	local ok=false; local method="none"; local route=math.clamp(math.floor(tonumber(__gg.MH_autoHitInputRoute) or 1),1,3)
	local function executorClick()
		if button==0 and typeof(mouse1press)=="function" and typeof(mouse1release)=="function" then method="executor down/up"; return pcall(function() mouse1press(); task.wait(0.035); mouse1release() end)
		elseif button==0 and typeof(mouse1click)=="function" then method="executor click"; return pcall(mouse1click)
		elseif button==1 and typeof(mouse2press)=="function" and typeof(mouse2release)=="function" then method="executor M2"; return pcall(function() mouse2press(); task.wait(0.035); mouse2release() end)
		elseif button==1 and typeof(mouse2click)=="function" then method="executor M2 click"; return pcall(mouse2click) end
		return false
	end
	local function virtualInputClick() method="VirtualInput"; return pcall(function() VIM:SendMouseButtonEvent(x,y,button,true,game,0); task.wait(0.04); VIM:SendMouseButtonEvent(x,y,button,false,game,0) end) end
	local function virtualUserClick() method="VirtualUser"; return pcall(function() local vu=game:GetService("VirtualUser"); vu:CaptureController(); local point=Vector2.new(x,y); if button==0 then vu:Button1Down(point,workspace.CurrentCamera.CFrame); task.wait(0.04); vu:Button1Up(point,workspace.CurrentCamera.CFrame) else vu:Button2Down(point,workspace.CurrentCamera.CFrame); task.wait(0.04); vu:Button2Up(point,workspace.CurrentCamera.CFrame) end end) end
	if route==1 then ok=executorClick(); if not ok then ok=virtualInputClick() end
	elseif route==2 then ok=virtualInputClick()
	else ok=virtualUserClick() end
	if not ok then ok=executorClick() end; if not ok then ok=virtualInputClick() end; if not ok then ok=virtualUserClick() end
	__gg.MH_autoHitClickMethod=ok and method or "failed"
	return ok
end
__gg.MH_autoHitM1=function(target)
	if __gg.MH_autoHitClicking or not (CFG.AutoHit and target and target==__gg.MH_autoHitLocked) then return false end
	local generation=__gg.MH_autoHitGen or 0
	...
	if not visible or screen.Z<=0 then
		pcall(function() cam.CFrame=CFrame.lookAt(cam.CFrame.Position,position) end)
		screen,visible=cam:WorldToViewportPoint(position)
	end
	__gg.MH_autoHitClicking=true; __gg.MH_autoHitTrackBone=aim; __gg.MH_autoHitTrackUntil=tick()+0.8
	local clickX=(visible and screen.Z>0 and screen.X) or (cam.ViewportSize.X*0.5); local clickY=(visible and screen.Z>0 and screen.Y) or (cam.ViewportSize.Y*0.5)
	pcall(function() VIM:SendMouseMoveEvent(clickX,clickY,game) end)
	local ok=pcall(function()
		if not (CFG.AutoHit and target==__gg.MH_autoHitLocked and generation==(__gg.MH_autoHitGen or 0)) then error("auto hit cancelled") end
		if not __gg.MH_autoHitClickButton(0,clickX,clickY) then error("no M1 input route") end
		if CFG.AutoHitRightClick and CFG.AutoHit and target==__gg.MH_autoHitLocked and generation==(__gg.MH_autoHitGen or 0) then
			task.wait(0.045); position=partPos(aim); screen,visible=cam:WorldToViewportPoint(position or Vector3.zero)
			if position and CFG.AutoHit and generation==(__gg.MH_autoHitGen or 0) then local x=(visible and screen.Z>0 and screen.X) or clickX; local y=(visible and screen.Z>0 and screen.Y) or clickY; VIM:SendMouseMoveEvent(x,y,game); __gg.MH_autoHitClickButton(1,x,y) end
		end
	end)
	__gg.MH_autoHitClicking=false
	if generation~=(__gg.MH_autoHitGen or 0) or not CFG.AutoHit then pcall(__gg.MH_autoHitReleaseClicks); return false,aim end
	return ok,aim
end
__gg.MH_autoHitM2=function(aim)
	local cam=workspace.CurrentCamera; local position=partPos(aim); if not (cam and position) then return false end
	local screen,visible=cam:WorldToViewportPoint(position); if not visible or screen.Z<=0 then return false end
	return pcall(function() VIM:SendMouseMoveEvent(screen.X,screen.Y,game); if not __gg.MH_autoHitClickButton(1,screen.X,screen.Y) then error("no M2 input route") end end)
end
...
task.spawn(function() while RUNNING do
	if CFG.AlwaysDamage and not CFG.AutoHit and alive() then
		...
		if me then
			...
			if #targs>0 then if __gg.MH_combatReady() then MHCOMBAT.sequence(targs) else __gg.MH_primeCombat(targs[1]) end end
		end
		task.wait(1/math.max(1,CFG.DamageRate))
	else task.wait(0.15) end
end end)
-- AUTO HIT: chase one locked target at any streamed distance, but do not click empty space while travelling. A real
-- M1 (and optional M2) is issued only when this dinosaur's jaw is in contact range of the live animated Head.
task.spawn(function() while RUNNING do
	if CFG.AutoHit and alive() then
		...
		if target then
			...
			local contact=math.max(7,(tonumber(CFG.AutoHitFollowDistance) or 4)+3); local inContact=position and jawPos and dist(jawPos,position)<=contact
			local boneName=tostring(aim and aim.Name or "Head")
			if not inContact then
				local gap=position and jawPos and math.floor(dist(jawPos,position)) or "?"; __gg.MH_autoHitSetStatus("Locked: "..target.Name.." | following "..boneName.." | "..tostring(gap).." studs")
				task.wait(0.08); continue
			end
			local started=tick(); __gg.MH_autoHitNativeReportAt=0; __gg.MH_autoHitNativeReportTarget=nil
			local clicked; clicked,aim=__gg.MH_autoHitM1(target); task.wait(0.12)
			if not (CFG.AutoHit and target==__gg.MH_autoHitLocked) then task.wait(0.05); continue end
			local native=__gg.MH_autoHitNativeReportTarget==target and (__gg.MH_autoHitNativeReportAt or 0)>=started
			local fallback=false
			if inContact and clicked and not native and __gg.MH_combatReady() then fallback=MHCOMBAT.sequence(target,aim)==true
			elseif inContact and clicked and not native then __gg.MH_primeCombat(target) end
			if inContact and clicked and not native then __gg.MH_autoHitInputRoute=((tonumber(__gg.MH_autoHitInputRoute) or 1)%3)+1 elseif native then __gg.MH_autoHitInputRoute=math.clamp(math.floor(tonumber(__gg.MH_autoHitInputRoute) or 1),1,3) end
			...
			elseif clicked then __gg.MH_autoHitSetStatus("Locked: "..target.Name.." | learning attack packet via "..tostring(__gg.MH_autoHitClickMethod or "input"))
...
conn(UIS.InputBegan:Connect(function(input, gp)
	...
	if __gg.MH_autoHitSelect then
		__gg.MH_autoHitSelect=false
		local selected=mouse.Target and __gg.MH_combatModelFromPart(mouse.Target)
		if selected and __gg.MH_autoHitLock(selected,true) then pcall(function() notify("Auto Hit","Locked "..selected.Name..". Red outline added.") end)
		else __gg.MH_autoHitSetStatus("No dinosaur selected"); pcall(function() notify("Auto Hit","That click was not on a dinosaur.") end) end
		return
	end
...
hbTouched={}
hbSeen={}
HBX={boneToPart=setmetatable({}, {__mode="k"}),partToBone=setmetatable({}, {__mode="k"}),modelProxy=setmetatable({}, {__mode="k"})}
...
function HBX.expandSource(source,model)
	...
	if not (p and p.Parent) then
		...
		p=Instance.new("Part"); p.Name=source.Name; p.Anchored=true; p.CastShadow=false; p.CanCollide=false; p.CanTouch=false; p.CanQuery=true; p.Parent=folder
		HBX.boneToPart[source]=p; HBX.partToBone[p]=source
	end
	local pos=_bonePos(source); if not pos then return nil end
	pcall(function() p.CFrame=source:IsA("BasePart") and source.CFrame or CFrame.new(pos) end); expandPart(p); return p
end
function HBX.expandBone(bone,model) return HBX.expandSource(bone,model) end
...
local function expandModel(m)
	if not m then return end
	local grewAny=false; local bones={}; local boneSeen={}; local sourceCount=0
	...
	if not grewAny then
		local hrp2=m:FindFirstChild("HumanoidRootPart"); if hrp2 and hrp2:IsA("BasePart") and (CFG.HitboxBone=="All" or CFG.HitboxBone=="Body") then if HBX.expandSource(hrp2,m) then grewAny=true; sourceCount+=1 end end
		local cnt=0
	...
	-- Guaranteed per-model proxy: even a newly streamed species with an empty/odd hitbox hierarchy receives one
	-- visible, queryable box immediately. It follows a real selected bone/part and never resizes the dinosaur's body.
...
-- AUTO LOCK ATTACKER: lock only on an actual local health drop and only to a creature whose live Head/Jaw is within
-- plausible bite reach at that instant. The lock is intentionally invisible and never becomes a saved manual target.
task.spawn(function()
	while RUNNING do task.wait(0.04)
		if not (CFG.AutoLockAttacker and alive()) then __gg.MH_autoLockLastHealth=nil; continue end
		pcall(function()
			local mine=getMyModel(); local hp=deathPointHealth(mine); if not hp then return end
			local last=tonumber(__gg.MH_autoLockLastHealth); __gg.MH_autoLockLastHealth=hp
			if not last or hp>=last-0.01 then return end
			if tick()-(__gg.MH_autoLockDamageAt or 0)<0.08 then return end; __gg.MH_autoLockDamageAt=tick()
			local myPoints={}; for _,part in ipairs({__gg.MH_autoHitHead(mine),_findIn(mine,"Spine"),hrp()}) do local position=partPos(part); if position then myPoints[#myPoints+1]=position end end
			if #myPoints==0 then return end
			local mySize=8; pcall(function() local size=mine:GetExtentsSize(); mySize=math.max(size.X,size.Z) end)
			local best,bestScore=nil,math.huge
			for _,model in ipairs(charModels()) do if model~=mine and not __gg.MH_autoHitDead(model) then
				local jaw=__gg.MH_autoHitHead(model); local position=partPos(jaw)
				if position then local gap=math.huge; for _,minePosition in ipairs(myPoints) do gap=math.min(gap,dist(minePosition,position)) end
					local theirSize=8; pcall(function() local size=model:GetExtentsSize(); theirSize=math.max(size.X,size.Z) end)
					local reach=math.clamp(12+(mySize+theirSize)*0.32,18,72)
					if gap<=reach then
					local attacking=false; pcall(function() local animator=model:FindFirstChildWhichIsA("Animator",true); if animator then for _,track in ipairs(animator:GetPlayingAnimationTracks()) do local name=tostring(track.Name or ""):lower(); if name:find("attack",1,true) or name:find("bite",1,true) or name:find("claw",1,true) then attacking=true; break end end end end)
					local score=gap-(attacking and math.min(18,reach*0.35) or 0); if score<bestScore then best,bestScore=model,score end
				end end
			end end
			if best then
				__gg.MH_autoLockTarget=best; __gg.MH_autoLockOwnedTarget=best; __gg.MH_autoLockStatus="retaliation lock: "..best.Name
				aimTarget=best; aimRoot=getHitbox(best) or rootOf(best); aimPart=__gg.MH_autoHitHead(best) or getAimPart(best)
				if CFG.AutoHit and type(__gg.MH_autoHitLock)=="function" then __gg.MH_autoHitLock(best,false,false) end
			else __gg.MH_autoLockStatus="damage seen; attacker not in bite reach" end
		end)
	end
end)
task.spawn(function()
	while RUNNING do
		task.wait(0.15)
		if (CFG.Aimbot or CFG.SilentAim or CFG.LockOn or (CFG.AutoLockAttacker and __gg.MH_autoLockTarget)) and alive() then
			...
			local keep=false
			local retaliate=CFG.AutoLockAttacker and __gg.MH_autoLockTarget
			if retaliate and retaliate.Parent and not __gg.MH_autoHitDead(retaliate) then aimTarget=retaliate; aimRoot=getHitbox(retaliate) or rootOf(retaliate); aimPart=__gg.MH_autoHitHead(retaliate) or getAimPart(retaliate); keep=aimRoot~=nil
			elseif retaliate then __gg.MH_autoLockTarget=nil end
			...
			if not keep and aimTarget and aimTarget.Parent and me then
...
conn(RunService.RenderStepped:Connect(function()
	if not (CFG.Aimbot or CFG.SilentAim or CFG.LockOn or (CFG.AutoLockAttacker and __gg.MH_autoLockTarget)) or not alive() then return end  -- no SG.Enabled gate (it's pinned true as the menu signal — it was killing the whole aim system)
	local held = true
	...
	if not (CFG.Aimbot or CFG.LockOn or (CFG.AutoLockAttacker and __gg.MH_autoLockTarget)) then return end
...
local function isCorpseFood(m, prompt)
	...
	if m and (m:FindFirstAncestor("CorpseSpawns") or m:FindFirstAncestor("SpawnedMeat") or m:FindFirstAncestor("LeftCharacters") or m:FindFirstAncestor("Bonepiles")) then return true end
...
_G.MH_edible = function(m, prompt)
	local selected=CFG.InfFoodDiet
...
task.spawn(function() while RUNNING do task.wait(0.3); pcall(function()
	...
	lines[#lines+1]="Food targets: "..tostring(__gg.MH_foodTargetCount or 0).." | "..tostring(__gg.MH_foodTargetKind or "none")
		...
		lines[#lines+1]="Food x"..tostring(CFG.FoodMultiplierX or 10)..": "..tostring(__gg.MH_foodMultState or "waiting").." | bonus sent "..tostring(__gg.MH_foodMultSent or 0)
		...
		lines[#lines+1]="Stamina speed: "..((__gg.MH_stamDriveSpeed or 0)>0 and ("native learned "..string.format("%.1f",__gg.MH_stamDriveSpeed)) or "learning").." | fixes "..tostring(__gg.MH_stamSpeedFixes or 0).." | Run observed "..tostring(__gg.MH_runShielded or 0).."x"
		...
		lines[#lines+1]="Incoming need guard: "..tostring(__gg.MH_incomingNeedState or "waiting")
		lines[#lines+1]="Stamina generic property: "..tostring(__gg.MH_stamGenericProperty or "learning")
		lines[#lines+1]="Stamina zero guard: lowest "..tostring(__gg.MH_stamLowestCurrent or "?").." | blocked "..tostring(__gg.MH_stamZeroTrips or 0).." | runtime "..tostring(#(__gg.MH_stamRuntimeAttrs or {})+#(__gg.MH_stamRuntimeValues or {})).." | watches "..tostring(#(__gg.MH_stamWatchConns or {}))
...
local function addESP(subject, color, label, hpFrac, stamFrac)
	if not subject or ESP.objs[subject] then return false end
	-- Corpses and fish are not consistently Models. PE can stream them as a Folder containing a ragdoll, a loose
	-- MeshPart, or a nested Visual/Hitbox model. Resolve every shape to one renderable subject + one real adornee.
	-- A loose corpse/spawn part must stay a loose part. Promoting it to FindFirstAncestorWhichIsA("Model") can select
	-- the giant map/biome model and turn the whole environment red (the screenshot failure).
	local model=subject:IsA("Model") and subject or ((not subject:IsA("BasePart") and not subject:IsA("Attachment")) and subject:FindFirstChildWhichIsA("Model",true) or nil)
	local r
	if subject:IsA("BasePart") or subject:IsA("Attachment") then r=subject
	elseif model then r=getHitbox(model) or rootOf(model) or model:FindFirstChildWhichIsA("BasePart",true)
	else r=subject:FindFirstChildWhichIsA("BasePart",true) end
	if not r then return false end
	local adornee=model or (subject:IsA("BasePart") and subject) or r
	...
	local h = Instance.new("Highlight"); h.FillColor=color; h.OutlineColor=Color3.new(1,1,1); h.FillTransparency=0.6; h.OutlineTransparency=0; h.DepthMode=Enum.HighlightDepthMode.AlwaysOnTop; h.Adornee=adornee; h.Parent=adornee
...
-- ESP is throttled (1.6s) and hard-capped, and the whole rebuild is pcall-wrapped,
...
task.spawn(function() while RUNNING do task.wait(1.6); pcall(function()
	...
	if CFG.FishESP then
		...
		local roots={}; local function fishRoot(root) if root then roots[#roots+1]=root end end
		fishRoot(sai and sai:FindFirstChild("Fish")); fishRoot(sai); fishRoot(ci and ci:FindFirstChild("Fish")); fishRoot(WS:FindFirstChild("SpawnedAI")); fishRoot(WS:FindFirstChild("Fish")); fishRoot(WS:FindFirstChild("Fishes"))
		local fishSeen={}; local scanned=0; local fishAdded=0
		local function markFish(item,root)
			if count>=MAX or not item then return end
			local model=item:IsA("Model") and item or item:FindFirstAncestorWhichIsA("Model")
			local part=(item:IsA("BasePart") and item) or (model and (getHitbox(model) or rootOf(model) or model:FindFirstChildWhichIsA("BasePart",true)))
			local subject=model or part; if not (subject and part and not fishSeen[subject]) then return end
			local named=isFishName(subject.Name) or isFishName(item.Name)
			local inFishFolder=item:FindFirstAncestor("Fish") or item:FindFirstAncestor("Fishes") or (root and (root.Name=="Fish" or root.Name=="Fishes"))
			if not (named or inFishFolder) then return end
			local d=dist(me.Position,part.Position); if d>CFG.ESPRange then return end
			fishSeen[subject]=true; if addESP(subject,Color3.fromRGB(90,210,255),"Fish: "..subject.Name.." ["..math.floor(d).."m]") then count+=1; fishAdded+=1 end
		end
		for _,root in ipairs(roots) do if root and count<MAX then
			markFish(root,root)
			for _,item in ipairs(root:GetDescendants()) do scanned+=1; if count>=MAX or scanned>12000 then break end
				if item:IsA("Model") or item:IsA("BasePart") then markFish(item,root) end
			end
		end end
		__gg.MH_lastFishESPCount=fishAdded
	end
...
conn(LP.CharacterAdded:Connect(function()
	...
	task.spawn(function() task.wait(1.5); for _=1,10 do if not RUNNING then break end if CFG.InfWater and alive() then fakeDrink() end task.wait(0.18) end end)
end))
...
task.spawn(function() while RUNNING do task.wait(0.5) pcall(function()
	...
	if HUD.stat then local on={}; if CFG.GodMode then on[#on+1]="God" end if CFG.FoodMultiplier then on[#on+1]="Food x"..tostring(CFG.FoodMultiplierX or 10) end if CFG.HitboxExpand then on[#on+1]="Hitbox" end if CFG.AutoFarmFossil then on[#on+1]="Fossil" end if CFG.AutoFarmGem then on[#on+1]="Gem" end HUD.stat.Text = #on>0 and table.concat(on,", ") or "idle" end
...
G.__PRIOR_EXT_HUB = function()
	...
	pcall(function() if type(__gg.MH_stamStopOwnedVelocity)=="function" then __gg.MH_stamStopOwnedVelocity() end end)
	pcall(function() if type(__gg.MH_stamRestoreWalkSpeed)=="function" then __gg.MH_stamRestoreWalkSpeed() end end)
	...
	pcall(function() if __gg.MH_autoHitReleaseClicks then __gg.MH_autoHitReleaseClicks() end end)
...
-- Install once at load so future dinosaur/respawn ReplicaCreate packets are observed even when INF Stamina is still
-- off. The wrapper is passive until a relevant toggle is enabled and is restored by the hub cleanup above.
pcall(function() if type(__gg.MH_installIncomingNeedGuard)=="function" then __gg.MH_installIncomingNeedGuard() end end)
...
print("[Dream Hub · Prior Extinction v8.17 PE-v4] Loaded — W-run stamina guard, invisible retaliation lock, predictive Head-only pursuit")
