...
notify("Dream Hub v3.0", "Open the FIGHT tab → LOCK + RUN COMBO. Chase is ON so hits land; Auto-block for defense.", 6)
print("[Dream] v3.0 loaded — reworked: Fight tab, chase-on default, auto-block, jump-tap launchers.")
