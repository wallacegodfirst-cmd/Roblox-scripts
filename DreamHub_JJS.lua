                ...
                function W:Page(pc)
                    ...
                    function P:SubPage()   -- Fluriore has no sub-pages; a SubPage just forwards to the tab
                        ...
                        function SP:Section(sc)
                            ...
                            function S:Textbox(c) c = c or {}; local el; local nm=c.Name or "Input"; local ph=c.Placeholder or c.PlaceholderText or ""; pcall(function() el = sec():AddInput({ Title = nm, Content = ph, Callback = c.Callback or function() end }) end); return elemWrap(el) end
                            return guard(S)
                        end
                        return guard(SP)
                    end
